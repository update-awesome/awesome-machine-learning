...
* <code>&nbsp;&nbsp;1439</code> ![](https://img.shields.io/github/last-commit/srendle/libfm) [libfm](https://github.com/srendle/libfm) - A generic approach that allows to mimic most factorization models by feature engineering.
...
* <code>&nbsp;&nbsp;3093</code> ![](https://img.shields.io/github/last-commit/gojek/feast) [Feast](https://github.com/gojek/feast) - A feature store for the management, discovery, and access of machine learning features. Feast provides a consistent view of feature data for both model training and model serving.
...
* <code>&nbsp;&nbsp;&nbsp;&nbsp;71</code> ![](https://img.shields.io/github/last-commit/cloudkj/lambda-ml) [lambda-ml](https://github.com/cloudkj/lambda-ml) - Simple, concise implementations of machine learning techniques and utilities in Clojure.
...
* <code>&nbsp;&nbsp;8280</code> ![](https://img.shields.io/github/last-commit/sjwhitworth/golearn) [golearn](https://github.com/sjwhitworth/golearn) - Machine learning for Go.
...
* <code>&nbsp;&nbsp;1523</code> ![](https://img.shields.io/github/last-commit/mmcloughlin/globe) [globe](https://github.com/mmcloughlin/globe) - Globe wireframe visualization.
...
* <code>&nbsp;&nbsp;&nbsp;&nbsp;24</code> ![](https://img.shields.io/github/last-commit/lukapopijac/gaussian-mixture-model) [Gaussian Mixture Model](https://github.com/lukapopijac/gaussian-mixture-model) - Unsupervised machine learning with multivariate Gaussian mixture model.
...
* <code>&nbsp;&nbsp;&nbsp;&nbsp;28</code> ![](https://img.shields.io/github/last-commit/nuanio/xgboost-node) [xgboost-node](https://github.com/nuanio/xgboost-node) - Run XGBoost model and make predictions in Node.js.
...
* <code>&nbsp;&nbsp;&nbsp;129</code> ![](https://img.shields.io/github/last-commit/JuliaStats/KernelDensity.jl) [Kernel Density](https://github.com/JuliaStats/KernelDensity.jl) - Kernel density estimators for julia.
...
* <code>&nbsp;&nbsp;&nbsp;&nbsp;29</code> ![](https://img.shields.io/github/last-commit/JuliaText/WordNet.jl) [WordNet](https://github.com/JuliaText/WordNet.jl) - A Julia package for Princeton's WordNet
...
* [Torch7](http://torch.ch/)
  ...
  * <code>&nbsp;&nbsp;&nbsp;&nbsp;43</code> ![](https://img.shields.io/github/last-commit/koraykv/torch-svm) [svm](https://github.com/koraykv/torch-svm) - Torch-SVM library. **[Deprecated]**
...
* <code>&nbsp;&nbsp;&nbsp;&nbsp;43</code> ![](https://img.shields.io/github/last-commit/e-lab/torch7-demos) [Core torch7 demos repository](https://github.com/e-lab/torch7-demos).
  ...
  * saliency-networks
* <code>&nbsp;&nbsp;&nbsp;&nbsp;36</code> ![](https://img.shields.io/github/last-commit/soumith/galaxyzoo) [Training a Convnet for the Galaxy-Zoo Kaggle challenge(CUDA demo)](https://github.com/soumith/galaxyzoo)
* <code>&nbsp;&nbsp;&nbsp;&nbsp;36</code> ![](https://img.shields.io/github/last-commit/rosejn/torch-datasets) [torch-datasets](https://github.com/rosejn/torch-datasets) - Scripts to load several popular datasets including:
  * BSR 500
  * CIFAR-10
  * COIL
  ...
  * MNIST
  * NORB
* <code>&nbsp;&nbsp;&nbsp;&nbsp;18</code> ![](https://img.shields.io/github/last-commit/fidlej/aledataset) [Atari2600](https://github.com/fidlej/aledataset) - Scripts to generate a dataset with static frames from the Arcade Learning Environment.
...
* <code>&nbsp;&nbsp;1373</code> ![](https://img.shields.io/github/last-commit/Xtra-Computing/thundersvm) [ThunderSVM](https://github.com/Xtra-Computing/thundersvm) - An Open-Source SVM Library on GPUs and CPUs
* [LibLinear](https://www.csie.ntu.edu.tw/~cjlin/liblinear/#download) - A Library for Large Linear Classification.
* <code>&nbsp;&nbsp;&nbsp;434</code> ![](https://img.shields.io/github/last-commit/josephmisiti/machine-learning-module) [Machine Learning Module](https://github.com/josephmisiti/machine-learning-module) - Class on machine w/ PDF, lectures, code
* <code>&nbsp;32513</code> ![](https://img.shields.io/github/last-commit/BVLC/caffe) [Caffe](https://github.com/BVLC/caffe) - A deep learning framework developed with cleanliness, readability, and speed in mind.
* <code>&nbsp;&nbsp;&nbsp;140</code> ![](https://img.shields.io/github/last-commit/covartech/PRT) [Pattern Recognition Toolbox](https://github.com/covartech/PRT) - A complete object-oriented environment for machine learning in Matlab.
* <code>&nbsp;&nbsp;5501</code> ![](https://img.shields.io/github/last-commit/PRML/PRMLT) [Pattern Recognition and Machine Learning](https://github.com/PRML/PRMLT) - This package contains the matlab implementation of the algorithms described in the book Pattern Recognition and Machine Learning by C. Bishop.
...
* <code>&nbsp;19941</code> ![](https://img.shields.io/github/last-commit/apache/incubator-mxnet) [MXNet](https://github.com/apache/incubator-mxnet/) - Lightweight, Portable, Flexible Distributed/Mobile Deep Learning with Dynamic, Mutation-aware Dataflow Dep Scheduler; for Python, R, Julia, Go, Javascript and more.
* <code>&nbsp;&nbsp;&nbsp;725</code> ![](https://img.shields.io/github/last-commit/trekhleb/machine-learning-octave) [Machine Learning in MatLab/Octave](https://github.com/trekhleb/machine-learning-octave) - examples of popular machine learning algorithms (neural networks, linear/logistic regressions, K-Means, etc.) with code examples and mathematics behind them being explained.
...
* <code>&nbsp;&nbsp;&nbsp;551</code> ![](https://img.shields.io/github/last-commit/sergey-tihon/Stanford.NLP.NET) [Stanford.NLP for .NET](https://github.com/sergey-tihon/Stanford.NLP.NET/) - A full port of Stanford NLP packages to .NET and also available precompiled as a NuGet package.
...
* <code>&nbsp;&nbsp;&nbsp;947</code> ![](https://img.shields.io/github/last-commit/giacomelli/GeneticSharp) [GeneticSharp](https://github.com/giacomelli/GeneticSharp) - Multi-platform genetic algorithm library for .NET Core and .NET Framework. The library has several implementations of GA operators, like: selection, crossover, mutation, reinsertion and termination.
...
* <code>&nbsp;&nbsp;7899</code> ![](https://img.shields.io/github/last-commit/dotnet/machinelearning) [ML.NET](https://github.com/dotnet/machinelearning) - ML.NET is a cross-platform open-source machine learning framework which makes machine learning accessible to .NET developers. ML.NET was originally developed in Microsoft Research and evolved into a significant framework over the last decade and is used across many product groups in Microsoft like Windows, Bing, PowerPoint, Excel and more.
...
* <code>&nbsp;&nbsp;&nbsp;&nbsp;63</code> ![](https://img.shields.io/github/last-commit/mrdimosthenis/Synapses) [Synapses](https://github.com/mrdimosthenis/Synapses) - Neural network library in F#.
* <code>&nbsp;&nbsp;&nbsp;116</code> ![](https://img.shields.io/github/last-commit/fsprojects/Vulpes) [Vulpes](https://github.com/fsprojects/Vulpes) - Deep belief and deep learning implementation written in F# and leverages CUDA GPU execution with Alea.cuBase.
* <code>&nbsp;&nbsp;&nbsp;138</code> ![](https://img.shields.io/github/last-commit/tech-quantum/MxNet.Sharp) [MxNet.Sharp](https://github.com/tech-quantum/MxNet.Sharp) - .NET Standard bindings for Apache MxNet with Imperative, Symbolic and Gluon Interface for developing, training and deploying Machine Learning models in C#. https://mxnet.tech-quantum.com/
...
* <code>&nbsp;&nbsp;&nbsp;117</code> ![](https://img.shields.io/github/last-commit/yconst/YCML) [YCML](https://github.com/yconst/YCML) - A Machine Learning framework for Objective-C and Swift (OS X / iOS).
* <code>&nbsp;&nbsp;&nbsp;904</code> ![](https://img.shields.io/github/last-commit/nikolaypavlov/MLPNeuralNet) [MLPNeuralNet](https://github.com/nikolaypavlov/MLPNeuralNet) - Fast multilayer perceptron neural network library for iOS and Mac OS X. MLPNeuralNet predicts new examples by trained neural networks. It is built on top of the Apple's Accelerate Framework, using vectorized operations and hardware acceleration if available. **[Deprecated]**
...
* <code>&nbsp;&nbsp;&nbsp;&nbsp;33</code> ![](https://img.shields.io/github/last-commit/Kalvar/ios-BPN-NeuralNetwork) [BPN-NeuralNetwork](https://github.com/Kalvar/ios-BPN-NeuralNetwork) - It implemented 3 layers of neural networks ( Input Layer, Hidden Layer and Output Layer ) and it was named Back Propagation Neural Networks (BPN). This network can be used in products recommendation, user behavior analysis, data mining and data analysis. **[Deprecated]**
* <code>&nbsp;&nbsp;&nbsp;&nbsp;24</code> ![](https://img.shields.io/github/last-commit/Kalvar/ios-Multi-Perceptron-NeuralNetwork) [Multi-Perceptron-NeuralNetwork](https://github.com/Kalvar/ios-Multi-Perceptron-NeuralNetwork) - it implemented multi-perceptrons neural network (ニューラルネットワーク) based on Back Propagation Neural Networks (BPN) and designed unlimited-hidden-layers.
* <code>&nbsp;&nbsp;&nbsp;&nbsp;12</code> ![](https://img.shields.io/github/last-commit/Kalvar/ios-KRHebbian-Algorithm) [KRHebbian-Algorithm](https://github.com/Kalvar/ios-KRHebbian-Algorithm) - It is a non-supervisor and self-learning algorithm (adjust the weights) in the neural network of Machine Learning. **[Deprecated]**
* <code>&nbsp;&nbsp;&nbsp;&nbsp;23</code> ![](https://img.shields.io/github/last-commit/Kalvar/ios-KRKmeans-Algorithm) [KRKmeans-Algorithm](https://github.com/Kalvar/ios-KRKmeans-Algorithm) - It implemented K-Means  clustering and classification algorithm. It could be used in data mining and image compression. **[Deprecated]**
* <code>&nbsp;&nbsp;&nbsp;&nbsp;11</code> ![](https://img.shields.io/github/last-commit/Kalvar/ios-KRFuzzyCMeans-Algorithm) [KRFuzzyCMeans-Algorithm](https://github.com/Kalvar/ios-KRFuzzyCMeans-Algorithm) - It implemented Fuzzy C-Means (FCM) the fuzzy clustering / classification algorithm on Machine Learning. It could be used in data mining and image compression. **[Deprecated]**
...
* <code>&nbsp;&nbsp;&nbsp;112</code> ![](https://img.shields.io/github/last-commit/rleonid/oml) [Oml](https://github.com/rleonid/oml) - A general statistics and machine learning library.
...
* <code>&nbsp;&nbsp;&nbsp;279</code> ![](https://img.shields.io/github/last-commit/LaurentMazare/tensorflow-ocaml) [TensorFlow](https://github.com/LaurentMazare/tensorflow-ocaml) - OCaml bindings for TensorFlow.
...
be <code>&nbsp;&nbsp;&nbsp;&nbsp;15</code> ![](https://img.shields.io/github/last-commit/zenogantner/PDL-ML) [used for machine learning](https://github.com/zenogantner/PDL-ML).

<a name="perl-general-purpose-machine-learning"></a>
### General-Purpose Machine Learning

* <code>&nbsp;19941</code> ![](https://img.shields.io/github/last-commit/apache/incubator-mxnet) [MXnet for Deep Learning, in Perl](https://github.com/apache/incubator-mxnet/tree/master/perl-package),
...
* <code>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;7</code> ![](https://img.shields.io/github/last-commit/titsuki/p6-Algorithm-LibSVM) [Support Vector Machines](https://github.com/titsuki/p6-Algorithm-LibSVM)
* <code>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;3</code> ![](https://img.shields.io/github/last-commit/titsuki/p6-Algorithm-NaiveBayes) [Naïve Bayes](https://github.com/titsuki/p6-Algorithm-NaiveBayes)
...
be
<code>&nbsp;&nbsp;&nbsp;&nbsp;15</code> ![](https://img.shields.io/github/last-commit/zenogantner/PDL-ML) [used for machine learning](https://github.com/zenogantner/PDL-ML).
...
* <code>&nbsp;&nbsp;1159</code> ![](https://img.shields.io/github/last-commit/fukuball/jieba-php) [jieba-php](https://github.com/fukuball/jieba-php) - Chinese Words Segmentation Utilities.
...
* <code>&nbsp;&nbsp;&nbsp;107</code> ![](https://img.shields.io/github/last-commit/denissimon/prediction-builder) [PredictionBuilder](https://github.com/denissimon/prediction-builder) - A library for machine learning that builds predictions using a linear regression.
...
* <code>&nbsp;&nbsp;&nbsp;&nbsp;15</code> ![](https://img.shields.io/github/last-commit/fulldecent/19-questions) [19 Questions](https://github.com/fulldecent/19-questions) - A machine learning / bayesian inference assigning attributes to objects.
...
* <code>&nbsp;&nbsp;4865</code> ![](https://img.shields.io/github/last-commit/scikit-image/scikit-image) [Scikit-Image](https://github.com/scikit-image/scikit-image) - A collection of algorithms for image processing in Python.
* <code>&nbsp;&nbsp;3102</code> ![](https://img.shields.io/github/last-commit/guofei9987/scikit-opt) [Scikit-Opt](https://github.com/guofei9987/scikit-opt) - Swarm Intelligence in Python (Genetic Algorithm, Particle Swarm Optimization, Simulated Annealing, Ant Colony Algorithm, Immune Algorithm,Artificial Fish Swarm Algorithm in Python)
* [SimpleCV](http://simplecv.org/) - An open source computer vision framework that gives access to several high-powered computer vision libraries, such as OpenCV. Written on Python and runs on Mac, Windows, and Ubuntu Linux.
* <code>&nbsp;&nbsp;&nbsp;365</code> ![](https://img.shields.io/github/last-commit/ukoethe/vigra) [Vigranumpy](https://github.com/ukoethe/vigra) - Python bindings for the VIGRA C++ computer vision library.
* [OpenFace](https://cmusatyalab.github.io/openface/) - Free and open source face recognition with deep neural networks.
* <code>&nbsp;&nbsp;1826</code> ![](https://img.shields.io/github/last-commit/jesolem/PCV) [PCV](https://github.com/jesolem/PCV) - Open source Python module for computer vision. **[Deprecated]**
* <code>&nbsp;43889</code> ![](https://img.shields.io/github/last-commit/ageitgey/face_recognition) [face_recognition](https://github.com/ageitgey/face_recognition) - Face recognition library that recognizes and manipulates faces from Python or from the command line.
* <code>&nbsp;&nbsp;3585</code> ![](https://img.shields.io/github/last-commit/serengil/deepface) [deepface](https://github.com/serengil/deepface) - A lightweight face recognition and facial attribute analysis (age, gender, emotion and race) framework for Python covering cutting-edge models such as VGG-Face, FaceNet, OpenFace, DeepFace, DeepID, Dlib and ArcFace.
* <code>&nbsp;&nbsp;&nbsp;266</code> ![](https://img.shields.io/github/last-commit/serengil/retinaface) [retinaface](https://github.com/serengil/retinaface) - deep learning based cutting-edge facial detector for Python coming with facial landmarks
* <code>&nbsp;&nbsp;&nbsp;177</code> ![](https://img.shields.io/github/last-commit/natanielruiz/dockerface) [dockerface](https://github.com/natanielruiz/dockerface) - Easy to install and use deep learning Faster R-CNN face detection for images and video in a docker container. **[Deprecated]**
* <code>&nbsp;25074</code> ![](https://img.shields.io/github/last-commit/facebookresearch/Detectron) [Detectron](https://github.com/facebookresearch/Detectron) - FAIR's software system that implements state-of-the-art object detection algorithms, including Mask R-CNN. It is written in Python and powered by the Caffe2 deep learning framework. **[Deprecated]**
* <code>&nbsp;20560</code> ![](https://img.shields.io/github/last-commit/facebookresearch/detectron2) [detectron2](https://github.com/facebookresearch/detectron2) - FAIR's next-generation research platform for object detection and segmentation. It is a ground-up rewrite of the previous version, Detectron, and is powered by the PyTorch deep learning framework.
* <code>&nbsp;10030</code> ![](https://img.shields.io/github/last-commit/albu/albumentations) [albumentations](https://github.com/albu/albumentations) - А fast and framework agnostic image augmentation library that implements a diverse set of augmentation techniques. Supports classification, segmentation, detection out of the box. Was used to win a number of Deep Learning competitions at Kaggle, Topcoder and those that were a part of the CVPR workshops.
* <code>&nbsp;&nbsp;4158</code> ![](https://img.shields.io/github/last-commit/madmaze/pytesseract) [pytessarct](https://github.com/madmaze/pytesseract) - Python-tesseract is an optical character recognition (OCR) tool for python. That is, it will recognize and "read" the text embedded in images. Python-tesseract is a wrapper for <code>&nbsp;44782</code> ![](https://img.shields.io/github/last-commit/tesseract-ocr/tesseract) [Google's Tesseract-OCR Engine](https://github.com/tesseract-ocr/tesseract).
* <code>&nbsp;&nbsp;4047</code> ![](https://img.shields.io/github/last-commit/jrosebr1/imutils) [imutils](https://github.com/jrosebr1/imutils) - A library containing Convenience functions to make basic image processing operations such as translation, rotation, resizing, skeletonization, and displaying Matplotlib images easier with OpenCV and Python.
* <code>&nbsp;&nbsp;&nbsp;&nbsp;37</code> ![](https://img.shields.io/github/last-commit/donnyyou/PyTorchCV) [PyTorchCV](https://github.com/donnyyou/PyTorchCV) - A PyTorch-Based Framework for Deep Learning in Computer Vision.
* [Self-supervised learning](https://pytorch-lightning-bolts.readthedocs.io/en/latest/self_supervised_models.html)
* <code>&nbsp;&nbsp;&nbsp;677</code> ![](https://img.shields.io/github/last-commit/ProGamerGov/neural-style-pt) [neural-style-pt](https://github.com/ProGamerGov/neural-style-pt) - A PyTorch implementation of Justin Johnson's neural-style (neural style transfer).
* <code>&nbsp;&nbsp;&nbsp;542</code> ![](https://img.shields.io/github/last-commit/alankbi/detecto) [Detecto](https://github.com/alankbi/detecto) - Train and run a computer vision model with 5-10 lines of code.
* <code>&nbsp;&nbsp;&nbsp;107</code> ![](https://img.shields.io/github/last-commit/ProGamerGov/neural-dream) [neural-dream](https://github.com/ProGamerGov/neural-dream) - A PyTorch implementation of DeepDream.
* <code>&nbsp;23938</code> ![](https://img.shields.io/github/last-commit/CMU-Perceptual-Computing-Lab/openpose) [Openpose](https://github.com/CMU-Perceptual-Computing-Lab/openpose) - A real-time multi-person keypoint detection library for body, face, hands, and foot estimation
* <code>&nbsp;&nbsp;3674</code> ![](https://img.shields.io/github/last-commit/leoxiaobin/deep-high-resolution-net.pytorch) [Deep High-Resolution-Net](https://github.com/leoxiaobin/deep-high-resolution-net.pytorch) - A PyTorch implementation of CVPR2019 paper "Deep High-Resolution Representation Learning for Human Pose Estimation"
* <code>&nbsp;&nbsp;&nbsp;&nbsp;43</code> ![](https://img.shields.io/github/last-commit/ProGamerGov/dream-creator) [dream-creator](https://github.com/ProGamerGov/dream-creator) - A PyTorch implementation of DeepDream. Allows individuals to quickly and easily train their own custom GoogleNet models with custom datasets for DeepDream.
* <code>&nbsp;&nbsp;&nbsp;450</code> ![](https://img.shields.io/github/last-commit/greentfrapp/lucent) [Lucent](https://github.com/greentfrapp/lucent) - Tensorflow and OpenAI Clarity's Lucid adapted for PyTorch.
* <code>&nbsp;&nbsp;1545</code> ![](https://img.shields.io/github/last-commit/lightly-ai/lightly) [lightly](https://github.com/lightly-ai/lightly) - Lightly is a computer vision framework for self-supervised learning.
* <code>&nbsp;&nbsp;&nbsp;&nbsp;43</code> ![](https://img.shields.io/github/last-commit/gugarosa/learnergy) [Learnergy](https://github.com/gugarosa/learnergy) - Energy-based machine learning models built upon PyTorch.
* [OpenVisionAPI](https://github.com/openvisionapi) - Open source computer vision API based on open source models.
* <code>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;5</code> ![](https://img.shields.io/github/last-commit/Ret2Me/IoT-Owl) [IoT Owl](https://github.com/Ret2Me/IoT-Owl) - Light face detection and recognition system with huge possibilities, based on Microsoft Face API and TensorFlow made for small IoT devices like raspberry pi.
* <code>&nbsp;&nbsp;1830</code> ![](https://img.shields.io/github/last-commit/exadel-inc/CompreFace) [Exadel CompreFace](https://github.com/exadel-inc/CompreFace) - face recognition system that can be easily integrated into any system without prior machine learning skills. CompreFace provides REST API for face recognition, face verification, face detection, face mask detection, landmark detection, age, and gender recognition and is easily deployed with docker.
* <code>&nbsp;&nbsp;1371</code> ![](https://img.shields.io/github/last-commit/Charmve/computer-vision-in-action) [computer-vision-in-action](https://github.com/Charmve/computer-vision-in-action) - as known as ``L0CV``, is a new generation of computer vision open source online learning media, a cross-platform interactive learning framework integrating graphics, source code and HTML. the L0CV ecosystem — Notebook, Datasets, Source Code, and from Diving-in to Advanced — as well as the L0CV Hub.

<a name="python-natural-language-processing"></a>
#### Natural Language Processing

* <code>&nbsp;&nbsp;5823</code> ![](https://img.shields.io/github/last-commit/lancopku/pkuseg-python) [pkuseg-python](https://github.com/lancopku/pkuseg-python) - A better version of Jieba, developed by Peking University.
* [NLTK](https://www.nltk.org/) - A leading platform for building Python programs to work with human language data.
* <code>&nbsp;&nbsp;8195</code> ![](https://img.shields.io/github/last-commit/clips/pattern) [Pattern](https://github.com/clips/pattern) - A web mining module for the Python programming language. It has tools for natural language processing, machine learning, among others.
* <code>&nbsp;&nbsp;1226</code> ![](https://img.shields.io/github/last-commit/machinalis/quepy) [Quepy](https://github.com/machinalis/quepy) - A python framework to transform natural language questions to queries in a database query language.
...
* <code>&nbsp;&nbsp;&nbsp;126</code> ![](https://img.shields.io/github/last-commit/machinalis/yalign) [YAlign](https://github.com/machinalis/yalign) - A sentence aligner, a friendly tool for extracting parallel sentences from comparable corpora. **[Deprecated]**
* <code>&nbsp;28323</code> ![](https://img.shields.io/github/last-commit/fxsjy/jieba#jieba-1) [jieba](https://github.com/fxsjy/jieba#jieba-1) - Chinese Words Segmentation Utilities.
* <code>&nbsp;&nbsp;5760</code> ![](https://img.shields.io/github/last-commit/isnowfy/snownlp) [SnowNLP](https://github.com/isnowfy/snownlp) - A library for processing Chinese text.
* <code>&nbsp;&nbsp;&nbsp;132</code> ![](https://img.shields.io/github/last-commit/tasdikrahman/spammy) [spammy](https://github.com/tasdikrahman/spammy) - A library for email Spam filtering built on top of nltk
* <code>&nbsp;&nbsp;&nbsp;&nbsp;81</code> ![](https://img.shields.io/github/last-commit/fangpenlin/loso) [loso](https://github.com/fangpenlin/loso) - Another Chinese segmentation library. **[Deprecated]**
* <code>&nbsp;&nbsp;&nbsp;235</code> ![](https://img.shields.io/github/last-commit/duanhongyi/genius) [genius](https://github.com/duanhongyi/genius) - A Chinese segment based on Conditional Random Field.
* [KoNLPy](http://konlpy.org) - A Python package for Korean natural language processing.
* <code>&nbsp;&nbsp;&nbsp;120</code> ![](https://img.shields.io/github/last-commit/pprett/nut) [nut](https://github.com/pprett/nut) - Natural language Understanding Toolkit. **[Deprecated]**
* <code>&nbsp;&nbsp;&nbsp;204</code> ![](https://img.shields.io/github/last-commit/columbia-applied-data-science/rosetta) [Rosetta](https://github.com/columbia-applied-data-science/rosetta) - Text processing tools and wrappers (e.g. Vowpal Wabbit)
...
* <code>&nbsp;&nbsp;&nbsp;448</code> ![](https://img.shields.io/github/last-commit/proycon/pynlpl) [PyNLPl](https://github.com/proycon/pynlpl) - Python Natural Language Processing Library. General purpose NLP library for Python. Also contains some specific modules for parsing common NLP formats, most notably for [FoLiA](https://proycon.github.io/folia/), but also ARPA language models, Moses phrasetables, GIZA++ alignments.
* <code>&nbsp;&nbsp;&nbsp;246</code> ![](https://img.shields.io/github/last-commit/sergioburdisso/pyss3) [PySS3](https://github.com/sergioburdisso/pyss3) - Python package that implements a novel white-box machine learning model for text classification, called SS3. Since SS3 has the ability to visually explain its rationale, this package also comes with easy-to-use interactive visualizations tools ([online demos](http://tworld.io/ss3/)).
* <code>&nbsp;&nbsp;&nbsp;&nbsp;27</code> ![](https://img.shields.io/github/last-commit/proycon/python-ucto) [python-ucto](https://github.com/proycon/python-ucto) - Python binding to ucto (a unicode-aware rule-based tokenizer for various languages).
* <code>&nbsp;&nbsp;&nbsp;&nbsp;42</code> ![](https://img.shields.io/github/last-commit/proycon/python-frog) [python-frog](https://github.com/proycon/python-frog) - Python binding to Frog, an NLP suite for Dutch. (pos tagging, lemmatisation, dependency parsing, NER)
* <code>&nbsp;&nbsp;&nbsp;&nbsp;49</code> ![](https://img.shields.io/github/last-commit/EducationalTestingService/python-zpar) [python-zpar](https://github.com/EducationalTestingService/python-zpar) - Python bindings for <code>&nbsp;&nbsp;&nbsp;130</code> ![](https://img.shields.io/github/last-commit/frcchang/zpar) [ZPar](https://github.com/frcchang/zpar), a statistical part-of-speech-tagger, constituency parser, and dependency parser for English.
* <code>&nbsp;&nbsp;&nbsp;115</code> ![](https://img.shields.io/github/last-commit/proycon/colibri-core) [colibri-core](https://github.com/proycon/colibri-core) - Python binding to C++ library for extracting and working with basic linguistic constructions such as n-grams and skipgrams in a quick and memory-efficient way.
* <code>&nbsp;23157</code> ![](https://img.shields.io/github/last-commit/explosion/spaCy) [spaCy](https://github.com/explosion/spaCy) - Industrial strength NLP with Python and Cython.
* <code>&nbsp;&nbsp;&nbsp;&nbsp;64</code> ![](https://img.shields.io/github/last-commit/dmcc/PyStanfordDependencies) [PyStanfordDependencies](https://github.com/dmcc/PyStanfordDependencies) - Python interface for converting Penn Treebank trees to Stanford Dependencies.
* <code>&nbsp;&nbsp;&nbsp;108</code> ![](https://img.shields.io/github/last-commit/doukremt/distance) [Distance](https://github.com/doukremt/distance) - Levenshtein and Hamming distance computation. **[Deprecated]**
* <code>&nbsp;&nbsp;8646</code> ![](https://img.shields.io/github/last-commit/seatgeek/fuzzywuzzy) [Fuzzy Wuzzy](https://github.com/seatgeek/fuzzywuzzy) - Fuzzy String Matching in Python.
* <code>&nbsp;&nbsp;1643</code> ![](https://img.shields.io/github/last-commit/jamesturk/jellyfish) [jellyfish](https://github.com/jamesturk/jellyfish) - a python library for doing approximate and phonetic matching of strings.
* [editdistance](https://pypi.org/project/editdistance/) - fast implementation of edit distance.
* <code>&nbsp;&nbsp;1911</code> ![](https://img.shields.io/github/last-commit/chartbeat-labs/textacy) [textacy](https://github.com/chartbeat-labs/textacy) - higher-level NLP built on Spacy.
* <code>&nbsp;&nbsp;&nbsp;610</code> ![](https://img.shields.io/github/last-commit/dasmith/stanford-corenlp-python) [stanford-corenlp-python](https://github.com/dasmith/stanford-corenlp-python) - Python wrapper for <code>&nbsp;&nbsp;8427</code> ![](https://img.shields.io/github/last-commit/stanfordnlp/CoreNLP) [Stanford CoreNLP](https://github.com/stanfordnlp/CoreNLP) **[Deprecated]**
* <code>&nbsp;&nbsp;&nbsp;717</code> ![](https://img.shields.io/github/last-commit/cltk/cltk) [CLTK](https://github.com/cltk/cltk) - The Classical Language Toolkit.
* <code>&nbsp;13837</code> ![](https://img.shields.io/github/last-commit/RasaHQ/rasa) [Rasa](https://github.com/RasaHQ/rasa) - A "machine learning framework to automate text-and voice-based conversations."
* <code>&nbsp;&nbsp;&nbsp;&nbsp;12</code> ![](https://img.shields.io/github/last-commit/PPACI/yase) [yase](https://github.com/PPACI/yase) - Transcode sentence (or other sequence) to list of word vector .
* <code>&nbsp;&nbsp;1985</code> ![](https://img.shields.io/github/last-commit/aboSamoor/polyglot) [Polyglot](https://github.com/aboSamoor/polyglot) - Multilingual text (NLP) processing toolkit.
* <code>&nbsp;&nbsp;4208</code> ![](https://img.shields.io/github/last-commit/facebookresearch/DrQA) [DrQA](https://github.com/facebookresearch/DrQA) - Reading Wikipedia to answer open-domain questions.
* <code>&nbsp;&nbsp;3342</code> ![](https://img.shields.io/github/last-commit/dedupeio/dedupe) [Dedupe](https://github.com/dedupeio/dedupe) - A python library for accurate and scalable fuzzy matching, record deduplication and entity-resolution.
* <code>&nbsp;&nbsp;3636</code> ![](https://img.shields.io/github/last-commit/snipsco/snips-nlu) [Snips NLU](https://github.com/snipsco/snips-nlu) - Natural Language Understanding library for intent classification and entity extraction
* <code>&nbsp;&nbsp;1605</code> ![](https://img.shields.io/github/last-commit/Franck-Dernoncourt/NeuroNER) [NeuroNER](https://github.com/Franck-Dernoncourt/NeuroNER) - Named-entity recognition using neural networks providing state-of-the-art-results
* <code>&nbsp;&nbsp;5674</code> ![](https://img.shields.io/github/last-commit/deepmipt/DeepPavlov) [DeepPavlov](https://github.com/deepmipt/DeepPavlov/) - conversational AI library with many pre-trained Russian NLP models.
* <code>&nbsp;&nbsp;&nbsp;609</code> ![](https://img.shields.io/github/last-commit/bigartm/bigartm) [BigARTM](https://github.com/bigartm/bigartm) - topic modelling platform.
* <code>&nbsp;&nbsp;&nbsp;&nbsp;17</code> ![](https://img.shields.io/github/last-commit/gugarosa/nalp) [NALP](https://github.com/gugarosa/nalp) - A Natural Adversarial Language Processing framework built over Tensorflow.
* <code>&nbsp;&nbsp;&nbsp;200</code> ![](https://img.shields.io/github/last-commit/xhlulu/dl-translate) [DL Translate](https://github.com/xhlulu/dl-translate) - A deep learning-based translation library between 50 languages, built with `transformers`.

<a name="python-general-purpose-machine-learning"></a>
#### General-Purpose Machine Learning

 * <code>&nbsp;&nbsp;&nbsp;230</code> ![](https://img.shields.io/github/last-commit/AstraZeneca/rexmex) [RexMex](https://github.com/AstraZeneca/rexmex) -> A general purpose recommender metrics library for fair evaluation.
 * <code>&nbsp;&nbsp;&nbsp;487</code> ![](https://img.shields.io/github/last-commit/AstraZeneca/chemicalx) [ChemicalX](https://github.com/AstraZeneca/chemicalx) -> A PyTorch based deep learning library for drug pair scoring
 * <code>&nbsp;&nbsp;3261</code> ![](https://img.shields.io/github/last-commit/Azure/mmlspark) [Microsoft ML for Apache Spark](https://github.com/Azure/mmlspark) -> A distributed machine learning framework Apache Spark
 * <code>&nbsp;&nbsp;&nbsp;156</code> ![](https://img.shields.io/github/last-commit/benedekrozemberczki/shapley) [Shapley](https://github.com/benedekrozemberczki/shapley) -> A data-driven framework to quantify the value of classifiers in a machine learning ensemble.
 * <code>&nbsp;&nbsp;2976</code> ![](https://img.shields.io/github/last-commit/nidhaloff/igel) [igel](https://github.com/nidhaloff/igel) -> A delightful machine learning tool that allows you to train/fit, test and use models **without writing code**
 * <code>&nbsp;&nbsp;&nbsp;&nbsp;12</code> ![](https://img.shields.io/github/last-commit/Shanky-21/Machine_learning) [ML Model building](https://github.com/Shanky-21/Machine_learning) -> A Repository Containing Classification, Clustering, Regression, Recommender Notebooks with illustration to make them.
 * <code>&nbsp;&nbsp;&nbsp;895</code> ![](https://img.shields.io/github/last-commit/PyTorchLightning/deep-learning-project-template) [ML/DL project template](https://github.com/PyTorchLightning/deep-learning-project-template)
 * <code>&nbsp;&nbsp;1479</code> ![](https://img.shields.io/github/last-commit/benedekrozemberczki/pytorch_geometric_temporal) [PyTorch Geometric Temporal](https://github.com/benedekrozemberczki/pytorch_geometric_temporal) -> A temporal extension of PyTorch Geometric for dynamic graph representation learning.
 * <code>&nbsp;&nbsp;&nbsp;585</code> ![](https://img.shields.io/github/last-commit/benedekrozemberczki/littleballoffur) [Little Ball of Fur](https://github.com/benedekrozemberczki/littleballoffur) -> A graph sampling extension library for NetworkX with a Scikit-Learn like API.
 * <code>&nbsp;&nbsp;1575</code> ![](https://img.shields.io/github/last-commit/benedekrozemberczki/karateclub) [Karate Club](https://github.com/benedekrozemberczki/karateclub) -> An unsupervised machine learning extension library for NetworkX with a Scikit-Learn like API.
* <code>&nbsp;&nbsp;&nbsp;338</code> ![](https://img.shields.io/github/last-commit/AutoViML/Auto_ViML) [Auto_ViML](https://github.com/AutoViML/Auto_ViML) -> Automatically Build Variant Interpretable ML models fast! Auto_ViML is pronounced "auto vimal", is a comprehensive and scalable Python AutoML toolkit with imbalanced handling, ensembling, stacking and built-in feature selection. Featured in <a href="https://towardsdatascience.com/why-automl-is-an-essential-new-tool-for-data-scientists-2d9ab4e25e46?source=friends_link&sk=d03a0cc55c23deb497d546d6b9be0653">Medium article</a>.
* <code>&nbsp;&nbsp;5480</code> ![](https://img.shields.io/github/last-commit/yzhao062/pyod) [PyOD](https://github.com/yzhao062/pyod) -> Python Outlier Detection, comprehensive and scalable Python toolkit for detecting outlying objects in multivariate data. Featured for Advanced models, including Neural Networks/Deep Learning and Outlier Ensembles.
* <code>&nbsp;&nbsp;&nbsp;132</code> ![](https://img.shields.io/github/last-commit/neptune-ml/steppy) [steppy](https://github.com/neptune-ml/steppy) -> Lightweight, Python library for fast and reproducible machine learning experimentation. Introduces a very simple interface that enables clean machine learning pipeline design.
* <code>&nbsp;&nbsp;&nbsp;&nbsp;21</code> ![](https://img.shields.io/github/last-commit/neptune-ml/steppy-toolkit) [steppy-toolkit](https://github.com/neptune-ml/steppy-toolkit) -> Curated collection of the neural networks, transformers and models that make your machine learning work faster and more effective.
* <code>&nbsp;17148</code> ![](https://img.shields.io/github/last-commit/Microsoft/CNTK) [CNTK](https://github.com/Microsoft/CNTK) - Microsoft Cognitive Toolkit (CNTK), an open source deep-learning toolkit. Documentation can be found [here](https://docs.microsoft.com/cognitive-toolkit/).
* <code>&nbsp;&nbsp;&nbsp;698</code> ![](https://img.shields.io/github/last-commit/couler-proj/couler) [Couler](https://github.com/couler-proj/couler) - Unified interface for constructing and managing machine learning workflows on different workflow engines, such as Argo Workflows, Tekton Pipelines, and Apache Airflow.
* <code>&nbsp;&nbsp;1568</code> ![](https://img.shields.io/github/last-commit/ClimbsRocks/auto_ml) [auto_ml](https://github.com/ClimbsRocks/auto_ml) - Automated machine learning for production and analytics. Lets you focus on the fun parts of ML, while outputting production-ready code, and detailed analytics of your dataset and results. Includes support for NLP, XGBoost, CatBoost, LightGBM, and soon, deep learning.
* <code>&nbsp;&nbsp;&nbsp;709</code> ![](https://img.shields.io/github/last-commit/wannesm/dtaidistance) [dtaidistance](https://github.com/wannesm/dtaidistance) - High performance library for time series distances (DTW) and time series clustering.
* <code>&nbsp;&nbsp;&nbsp;247</code> ![](https://img.shields.io/github/last-commit/jeff1evesque/machine-learning) [machine learning](https://github.com/jeff1evesque/machine-learning) - automated build consisting of a <code>&nbsp;&nbsp;&nbsp;247</code> ![](https://img.shields.io/github/last-commit/jeff1evesque/machine-learning#web-interface) [web-interface](https://github.com/jeff1evesque/machine-learning#web-interface), and set of <code>&nbsp;&nbsp;&nbsp;247</code> ![](https://img.shields.io/github/last-commit/jeff1evesque/machine-learning#programmatic-interface) [programmatic-interface](https://github.com/jeff1evesque/machine-learning#programmatic-interface) API, for support vector machines. Corresponding dataset(s) are stored into a SQL database, then generated model(s) used for prediction(s), are stored into a NoSQL datastore.
* <code>&nbsp;22496</code> ![](https://img.shields.io/github/last-commit/dmlc/xgboost) [XGBoost](https://github.com/dmlc/xgboost) - Python bindings for eXtreme Gradient Boosting (Tree) Library.
* <code>&nbsp;&nbsp;&nbsp;312</code> ![](https://img.shields.io/github/last-commit/serengil/chefboost) [ChefBoost](https://github.com/serengil/chefboost) - a lightweight decision tree framework for Python with categorical feature support covering regular decision tree algorithms such as ID3, C4.5, CART, CHAID and regression tree; also some advanved bagging and boosting techniques such as gradient boosting, random forest and adaboost.
* [Apache SINGA](https://singa.apache.org) - An Apache Incubating project for developing an open source machine learning library.
* <code>&nbsp;24307</code> ![](https://img.shields.io/github/last-commit/CamDavidsonPilon/Probabilistic-Programming-and-Bayesian-Methods-for-Hackers) [Bayesian Methods for Hackers](https://github.com/CamDavidsonPilon/Probabilistic-Programming-and-Bayesian-Methods-for-Hackers) - Book/iPython notebooks on Probabilistic Programming in Python.
* <code>&nbsp;&nbsp;&nbsp;380</code> ![](https://img.shields.io/github/last-commit/machinalis/featureforge) [Featureforge](https://github.com/machinalis/featureforge) A set of tools for creating and testing machine learning features, with a scikit-learn compatible API.
...
* <code>&nbsp;&nbsp;1228</code> ![](https://img.shields.io/github/last-commit/metric-learn/metric-learn) [metric-learn](https://github.com/metric-learn/metric-learn) - A Python module for metric learning.
* <code>&nbsp;&nbsp;&nbsp;463</code> ![](https://img.shields.io/github/last-commit/intel/scikit-learn-intelex) [Intel(R) Extension for Scikit-learn](https://github.com/intel/scikit-learn-intelex) - A seamless way to speed up your Scikit-learn applications with no accuracy loss and code changes.
* <code>&nbsp;&nbsp;&nbsp;915</code> ![](https://img.shields.io/github/last-commit/simpleai-team/simpleai) [SimpleAI](https://github.com/simpleai-team/simpleai) Python implementation of many of the artificial intelligence algorithms described in the book "Artificial Intelligence, a Modern Approach". It focuses on providing an easy to use, well documented and tested library.
...
* <code>&nbsp;&nbsp;8195</code> ![](https://img.shields.io/github/last-commit/clips/pattern) [pattern](https://github.com/clips/pattern) - Web mining module for Python.
...
* <code>&nbsp;&nbsp;2719</code> ![](https://img.shields.io/github/last-commit/lisa-lab/pylearn2) [Pylearn2](https://github.com/lisa-lab/pylearn2) - A Machine Learning library based on <code>&nbsp;&nbsp;9559</code> ![](https://img.shields.io/github/last-commit/Theano/Theano) [Theano](https://github.com/Theano/Theano). **[Deprecated]**
* <code>&nbsp;54963</code> ![](https://img.shields.io/github/last-commit/keras-team/keras) [keras](https://github.com/keras-team/keras) - High-level neural networks frontend for <code>164305</code> ![](https://img.shields.io/github/last-commit/tensorflow/tensorflow) [TensorFlow](https://github.com/tensorflow/tensorflow), <code>&nbsp;17148</code> ![](https://img.shields.io/github/last-commit/Microsoft/CNTK) [CNTK](https://github.com/Microsoft/CNTK) and <code>&nbsp;&nbsp;9559</code> ![](https://img.shields.io/github/last-commit/Theano/Theano) [Theano](https://github.com/Theano/Theano).
* <code>&nbsp;&nbsp;3812</code> ![](https://img.shields.io/github/last-commit/Lasagne/Lasagne) [Lasagne](https://github.com/Lasagne/Lasagne) - Lightweight library to build and train neural networks in Theano.
* <code>&nbsp;&nbsp;1176</code> ![](https://img.shields.io/github/last-commit/hannes-brt/hebel) [hebel](https://github.com/hannes-brt/hebel) - GPU-Accelerated Deep Learning Library in Python. **[Deprecated]**
* <code>&nbsp;&nbsp;5674</code> ![](https://img.shields.io/github/last-commit/chainer/chainer) [Chainer](https://github.com/chainer/chainer) - Flexible neural network framework.
* [prophet](https://facebook.github.io/prophet/) - Fast and automated time series forecasting framework by Facebook.
* <code>&nbsp;13097</code> ![](https://img.shields.io/github/last-commit/RaRe-Technologies/gensim) [gensim](https://github.com/RaRe-Technologies/gensim) - Topic Modelling for Humans.
* <code>&nbsp;&nbsp;&nbsp;&nbsp;92</code> ![](https://img.shields.io/github/last-commit/ContinuumIO/topik) [topik](https://github.com/ContinuumIO/topik) - Topic modelling toolkit. **[Deprecated]**
* <code>&nbsp;&nbsp;2811</code> ![](https://img.shields.io/github/last-commit/pybrain/pybrain) [PyBrain](https://github.com/pybrain/pybrain) - Another Python Machine Learning Library.
* <code>&nbsp;&nbsp;1291</code> ![](https://img.shields.io/github/last-commit/IDSIA/brainstorm) [Brainstorm](https://github.com/IDSIA/brainstorm) - Fast, flexible and fun neural networks. This is the successor of PyBrain.
...
* <code>&nbsp;&nbsp;1138</code> ![](https://img.shields.io/github/last-commit/muricoca/crab) [Crab](https://github.com/muricoca/crab) - A flexible, fast recommender engine. **[Deprecated]**
* <code>&nbsp;&nbsp;1422</code> ![](https://img.shields.io/github/last-commit/ocelma/python-recsys) [python-recsys](https://github.com/ocelma/python-recsys) - A Python library for implementing a Recommender System.
* <code>&nbsp;&nbsp;1573</code> ![](https://img.shields.io/github/last-commit/AllenDowney/ThinkBayes) [thinking bayes](https://github.com/AllenDowney/ThinkBayes) - Book on Bayesian Analysis.
* <code>&nbsp;&nbsp;&nbsp;133</code> ![](https://img.shields.io/github/last-commit/williamFalcon/pix2pix-keras) [Image-to-Image Translation with Conditional Adversarial Networks](https://github.com/williamFalcon/pix2pix-keras) - Implementation of image to image (pix2pix) translation from the paper by [isola et al](https://arxiv.org/pdf/1611.07004.pdf).[DEEP LEARNING]
* <code>&nbsp;&nbsp;&nbsp;902</code> ![](https://img.shields.io/github/last-commit/echen/restricted-boltzmann-machines) [Restricted Boltzmann Machines](https://github.com/echen/restricted-boltzmann-machines) -Restricted Boltzmann Machines in Python. [DEEP LEARNING]
* <code>&nbsp;&nbsp;&nbsp;&nbsp;88</code> ![](https://img.shields.io/github/last-commit/pprett/bolt) [Bolt](https://github.com/pprett/bolt) - Bolt Online Learning Toolbox. **[Deprecated]**
* <code>&nbsp;&nbsp;&nbsp;&nbsp;26</code> ![](https://img.shields.io/github/last-commit/patvarilly/CoverTree) [CoverTree](https://github.com/patvarilly/CoverTree) - Python implementation of cover trees, near-drop-in replacement for scipy.spatial.kdtree **[Deprecated]**
* <code>&nbsp;&nbsp;&nbsp;825</code> ![](https://img.shields.io/github/last-commit/nilearn/nilearn) [nilearn](https://github.com/nilearn/nilearn) - Machine learning for NeuroImaging in Python.
* <code>&nbsp;&nbsp;&nbsp;&nbsp;88</code> ![](https://img.shields.io/github/last-commit/raamana/neuropredict) [neuropredict](https://github.com/raamana/neuropredict) - Aimed at novice machine learners and non-expert programmers, this package offers easy (no coding needed) and comprehensive machine learning (evaluation and full report of predictive performance WITHOUT requiring you to code) in Python for NeuroImaging and any other type of features. This is aimed at absorbing much of the ML workflow, unlike other packages like nilearn and pymvpa, which require you to learn their API and code to produce anything useful.
...
* <code>&nbsp;&nbsp;&nbsp;&nbsp;95</code> ![](https://img.shields.io/github/last-commit/ZhiningLiu1998/imbalanced-ensemble) [imbalanced-ensemble](https://github.com/ZhiningLiu1998/imbalanced-ensemble) - Python toolbox for quick implementation, modification, evaluation, and visualization of ensemble learning algorithms for class-imbalanced data. Supports out-of-the-box multi-class imbalanced (long-tailed) classification.
* <code>&nbsp;&nbsp;2880</code> ![](https://img.shields.io/github/last-commit/shogun-toolbox/shogun) [Shogun](https://github.com/shogun-toolbox/shogun) - The Shogun Machine Learning Toolbox.
* <code>&nbsp;&nbsp;&nbsp;305</code> ![](https://img.shields.io/github/last-commit/perone/Pyevolve) [Pyevolve](https://github.com/perone/Pyevolve) - Genetic algorithm framework. **[Deprecated]**
* <code>&nbsp;32513</code> ![](https://img.shields.io/github/last-commit/BVLC/caffe) [Caffe](https://github.com/BVLC/caffe) - A deep learning framework developed with cleanliness, readability, and speed in mind.
* <code>&nbsp;&nbsp;&nbsp;&nbsp;96</code> ![](https://img.shields.io/github/last-commit/breze-no-salt/breze) [breze](https://github.com/breze-no-salt/breze) - Theano based library for deep and recurrent neural networks.
* <code>&nbsp;&nbsp;7738</code> ![](https://img.shields.io/github/last-commit/cortexlabs/cortex) [Cortex](https://github.com/cortexlabs/cortex) - Open source platform for deploying machine learning models in production.
* <code>&nbsp;&nbsp;&nbsp;509</code> ![](https://img.shields.io/github/last-commit/mattjj/pyhsmm) [pyhsmm](https://github.com/mattjj/pyhsmm) - library for approximate unsupervised inference in Bayesian Hidden Markov Models (HMMs) and explicit-duration Hidden semi-Markov Models (HSMMs), focusing on the Bayesian Nonparametric extensions, the HDP-HMM and HDP-HSMM, mostly with weak-limit approximations.
* <code>&nbsp;&nbsp;&nbsp;525</code> ![](https://img.shields.io/github/last-commit/EducationalTestingService/skll) [SKLL](https://github.com/EducationalTestingService/skll) - A wrapper around scikit-learn that makes it simpler to conduct experiments.
* <code>&nbsp;&nbsp;&nbsp;151</code> ![](https://img.shields.io/github/last-commit/zueve/neurolab) [neurolab](https://github.com/zueve/neurolab)
* <code>&nbsp;&nbsp;1474</code> ![](https://img.shields.io/github/last-commit/HIPS/Spearmint) [Spearmint](https://github.com/HIPS/Spearmint) - Spearmint is a package to perform Bayesian optimization according to the algorithms outlined in the paper: Practical Bayesian Optimization of Machine Learning Algorithms. Jasper Snoek, Hugo Larochelle and Ryan P. Adams. Advances in Neural Information Processing Systems, 2012. **[Deprecated]**
* <code>&nbsp;&nbsp;&nbsp;102</code> ![](https://img.shields.io/github/last-commit/abhik/pebl) [Pebl](https://github.com/abhik/pebl/) - Python Environment for Bayesian Learning. **[Deprecated]**
* <code>&nbsp;&nbsp;9559</code> ![](https://img.shields.io/github/last-commit/Theano/Theano) [Theano](https://github.com/Theano/Theano/) - Optimizing GPU-meta-programming code generating array oriented optimizing math compiler in Python.
* <code>164305</code> ![](https://img.shields.io/github/last-commit/tensorflow/tensorflow) [TensorFlow](https://github.com/tensorflow/tensorflow/) - Open source software library for numerical computation using data flow graphs.
* <code>&nbsp;&nbsp;2877</code> ![](https://img.shields.io/github/last-commit/jmschrei/pomegranate) [pomegranate](https://github.com/jmschrei/pomegranate) - Hidden Markov Models for Python, implemented in Cython for speed and efficiency.
* <code>&nbsp;&nbsp;&nbsp;&nbsp;16</code> ![](https://img.shields.io/github/last-commit/proycon/python-timbl) [python-timbl](https://github.com/proycon/python-timbl) - A Python extension module wrapping the full TiMBL C++ programming interface. Timbl is an elaborate k-Nearest Neighbours machine learning toolkit.
* <code>&nbsp;&nbsp;4659</code> ![](https://img.shields.io/github/last-commit/deap/deap) [deap](https://github.com/deap/deap) - Evolutionary algorithm framework.
* <code>&nbsp;&nbsp;1353</code> ![](https://img.shields.io/github/last-commit/andersbll/deeppy) [pydeep](https://github.com/andersbll/deeppy) - Deep Learning In Python. **[Deprecated]**
* <code>&nbsp;&nbsp;3871</code> ![](https://img.shields.io/github/last-commit/rasbt/mlxtend) [mlxtend](https://github.com/rasbt/mlxtend) - A library consisting of useful tools for data science and machine learning tasks.
* <code>&nbsp;&nbsp;3861</code> ![](https://img.shields.io/github/last-commit/NervanaSystems/neon) [neon](https://github.com/NervanaSystems/neon) - Nervana's <code>&nbsp;&nbsp;2666</code> ![](https://img.shields.io/github/last-commit/soumith/convnet-benchmarks) [high-performance](https://github.com/soumith/convnet-benchmarks) Python-based Deep Learning framework [DEEP LEARNING]. **[Deprecated]**
...
* <code>&nbsp;13365</code> ![](https://img.shields.io/github/last-commit/mnielsen/neural-networks-and-deep-learning) [Neural Networks and Deep Learning](https://github.com/mnielsen/neural-networks-and-deep-learning) - Code samples for my book "Neural Networks and Deep Learning" [DEEP LEARNING].
* <code>&nbsp;&nbsp;9629</code> ![](https://img.shields.io/github/last-commit/spotify/annoy) [Annoy](https://github.com/spotify/annoy) - Approximate nearest neighbours implementation.
* <code>&nbsp;&nbsp;8523</code> ![](https://img.shields.io/github/last-commit/EpistasisLab/tpot) [TPOT](https://github.com/EpistasisLab/tpot) - Tool that automatically creates and optimizes machine learning pipelines using genetic programming. Consider it your personal data science assistant, automating a tedious part of machine learning.
* <code>&nbsp;&nbsp;2029</code> ![](https://img.shields.io/github/last-commit/pgmpy/pgmpy) [pgmpy](https://github.com/pgmpy/pgmpy) A python library for working with Probabilistic Graphical Models.
* <code>&nbsp;&nbsp;4055</code> ![](https://img.shields.io/github/last-commit/NVIDIA/DIGITS) [DIGITS](https://github.com/NVIDIA/DIGITS) - The Deep Learning GPU Training System (DIGITS) is a web application for training deep learning models.
* [Orange](https://orange.biolab.si/) - Open source data visualization and data analysis for novices and experts.
* <code>&nbsp;19941</code> ![](https://img.shields.io/github/last-commit/apache/incubator-mxnet) [MXNet](https://github.com/apache/incubator-mxnet) - Lightweight, Portable, Flexible Distributed/Mobile Deep Learning with Dynamic, Mutation-aware Dataflow Dep Scheduler; for Python, R, Julia, Go, Javascript and more.
* <code>&nbsp;&nbsp;&nbsp;610</code> ![](https://img.shields.io/github/last-commit/luispedro/milk) [milk](https://github.com/luispedro/milk) - Machine learning toolkit focused on supervised classification. **[Deprecated]**
* <code>&nbsp;&nbsp;9584</code> ![](https://img.shields.io/github/last-commit/tflearn/tflearn) [TFLearn](https://github.com/tflearn/tflearn) - Deep learning library featuring a higher-level API for TensorFlow.
* <code>&nbsp;&nbsp;&nbsp;651</code> ![](https://img.shields.io/github/last-commit/yandex/rep) [REP](https://github.com/yandex/rep) - an IPython-based environment for conducting data-driven research in a consistent and reproducible way. REP is not trying to substitute scikit-learn, but extends it and provides better user experience. **[Deprecated]**
* <code>&nbsp;&nbsp;&nbsp;356</code> ![](https://img.shields.io/github/last-commit/RGF-team/rgf) [rgf_python](https://github.com/RGF-team/rgf) - Python bindings for Regularized Greedy Forest (Tree) Library.
* <code>&nbsp;&nbsp;&nbsp;457</code> ![](https://img.shields.io/github/last-commit/AmazaspShumik/sklearn-bayes) [skbayes](https://github.com/AmazaspShumik/sklearn-bayes) - Python package for Bayesian Machine Learning with scikit-learn API.
* <code>&nbsp;&nbsp;&nbsp;281</code> ![](https://img.shields.io/github/last-commit/fukuball/fuku-ml) [fuku-ml](https://github.com/fukuball/fuku-ml) - Simple machine learning library, including Perceptron, Regression, Support Vector Machine, Decision Tree and more, it's easy to use and easy to learn for beginners.
* <code>&nbsp;&nbsp;1262</code> ![](https://img.shields.io/github/last-commit/reiinakano/xcessiv) [Xcessiv](https://github.com/reiinakano/xcessiv) - A web-based application for quick, scalable, and automated hyperparameter tuning and stacked ensembling.
* <code>&nbsp;55361</code> ![](https://img.shields.io/github/last-commit/pytorch/pytorch) [PyTorch](https://github.com/pytorch/pytorch) - Tensors and Dynamic neural networks in Python with strong GPU acceleration
* <code>&nbsp;18060</code> ![](https://img.shields.io/github/last-commit/PyTorchLightning/pytorch-lightning) [PyTorch Lightning](https://github.com/PyTorchLightning/pytorch-lightning) - The lightweight PyTorch wrapper for high-performance AI research.
* <code>&nbsp;&nbsp;1287</code> ![](https://img.shields.io/github/last-commit/PyTorchLightning/pytorch-lightning-bolts) [PyTorch Lightning Bolts](https://github.com/PyTorchLightning/pytorch-lightning-bolts) - Toolbox of models, callbacks, and datasets for AI/ML researchers.
* <code>&nbsp;&nbsp;4450</code> ![](https://img.shields.io/github/last-commit/skorch-dev/skorch) [skorch](https://github.com/skorch-dev/skorch) - A scikit-learn compatible neural network library that wraps PyTorch.
* <code>&nbsp;20988</code> ![](https://img.shields.io/github/last-commit/eriklindernoren/ML-From-Scratch) [ML-From-Scratch](https://github.com/eriklindernoren/ML-From-Scratch) - Implementations of Machine Learning models from scratch in Python with a focus on transparency. Aims to showcase the nuts and bolts of ML in an accessible way.
* [Edward](http://edwardlib.org/) - A library for probabilistic modeling, inference, and criticism. Built on top of TensorFlow.
* <code>&nbsp;&nbsp;&nbsp;&nbsp;51</code> ![](https://img.shields.io/github/last-commit/omimo/xRBM) [xRBM](https://github.com/omimo/xRBM) - A library for Restricted Boltzmann Machine (RBM) and its conditional variants in Tensorflow.
* <code>&nbsp;&nbsp;6464</code> ![](https://img.shields.io/github/last-commit/catboost/catboost) [CatBoost](https://github.com/catboost/catboost) - General purpose gradient boosting on decision trees library with categorical features support out of the box. It is easy to install, well documented and supports CPU and GPU (even multi-GPU) computation.
* <code>&nbsp;&nbsp;&nbsp;113</code> ![](https://img.shields.io/github/last-commit/fukatani/stacked_generalization) [stacked_generalization](https://github.com/fukatani/stacked_generalization) - Implementation of machine learning stacking technique as a handy library in Python.
* <code>&nbsp;&nbsp;1663</code> ![](https://img.shields.io/github/last-commit/modAL-python/modAL) [modAL](https://github.com/modAL-python/modAL) - A modular active learning framework for Python, built on top of scikit-learn.
* <code>&nbsp;&nbsp;&nbsp;&nbsp;75</code> ![](https://img.shields.io/github/last-commit/cogitare-ai/cogitare) [Cogitare](https://github.com/cogitare-ai/cogitare): A Modern, Fast, and Modular Deep Learning and Machine Learning framework for Python.
* <code>&nbsp;&nbsp;&nbsp;320</code> ![](https://img.shields.io/github/last-commit/jgreenemi/Parris) [Parris](https://github.com/jgreenemi/Parris) - Parris, the automated infrastructure setup tool for machine learning algorithms.
* <code>&nbsp;&nbsp;&nbsp;&nbsp;34</code> ![](https://img.shields.io/github/last-commit/siavashserver/neonrvm) [neonrvm](https://github.com/siavashserver/neonrvm) - neonrvm is an open source machine learning library based on RVM technique. It's written in C programming language and comes with Python programming language bindings.
* <code>&nbsp;10659</code> ![](https://img.shields.io/github/last-commit/apple/turicreate) [Turi Create](https://github.com/apple/turicreate) - Machine learning from Apple. Turi Create simplifies the development of custom machine learning models. You don't have to be a machine learning expert to add recommendations, object detection, image classification, image similarity or activity classification to your app.
* <code>&nbsp;&nbsp;2993</code> ![](https://img.shields.io/github/last-commit/aksnzhy/xlearn) [xLearn](https://github.com/aksnzhy/xlearn) - A high performance, easy-to-use, and scalable machine learning package, which can be used to solve large-scale machine learning problems. xLearn is especially useful for solving machine learning problems on large-scale sparse data, which is very common in Internet services such as online advertisement and recommender systems.
* <code>&nbsp;&nbsp;&nbsp;730</code> ![](https://img.shields.io/github/last-commit/flennerhag/mlens) [mlens](https://github.com/flennerhag/mlens) - A high performance, memory efficient, maximally parallelized ensemble learning, integrated with scikit-learn.
* <code>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;9</code> ![](https://img.shields.io/github/last-commit/scoremedia/thampi) [Thampi](https://github.com/scoremedia/thampi) - Machine Learning Prediction System on AWS Lambda
* <code>&nbsp;&nbsp;6499</code> ![](https://img.shields.io/github/last-commit/mindsdb/mindsdb) [MindsDB](https://github.com/mindsdb/mindsdb) - Open Source framework to streamline use of neural networks.
* <code>&nbsp;12884</code> ![](https://img.shields.io/github/last-commit/Microsoft/Recommenders) [Microsoft Recommenders](https://github.com/Microsoft/Recommenders): Examples and best practices for building recommendation systems, provided as Jupyter notebooks. The repo contains some of the latest state of the art algorithms from Microsoft Research as well as from other companies and institutions.
* <code>&nbsp;&nbsp;2350</code> ![](https://img.shields.io/github/last-commit/stellargraph/stellargraph) [StellarGraph](https://github.com/stellargraph/stellargraph): Machine Learning on Graphs, a Python library for machine learning on graph-structured (network-structured) data.
* <code>&nbsp;&nbsp;3402</code> ![](https://img.shields.io/github/last-commit/bentoml/bentoml) [BentoML](https://github.com/bentoml/bentoml): Toolkit for package and deploy machine learning models for serving in production
* <code>&nbsp;&nbsp;&nbsp;&nbsp;23</code> ![](https://img.shields.io/github/last-commit/arthurpaulino/miraiml) [MiraiML](https://github.com/arthurpaulino/miraiml): An asynchronous engine for continuous & autonomous machine learning, built for real-time usage.
* <code>&nbsp;11314</code> ![](https://img.shields.io/github/last-commit/ddbourgin/numpy-ml) [numpy-ML](https://github.com/ddbourgin/numpy-ml): Reference implementations of ML models written in numpy
* <code>&nbsp;&nbsp;&nbsp;514</code> ![](https://img.shields.io/github/last-commit/Neuraxio/Neuraxle) [Neuraxle](https://github.com/Neuraxio/Neuraxle): A framework providing the right abstractions to ease research, development, and deployment of your ML pipelines.
* <code>&nbsp;&nbsp;&nbsp;565</code> ![](https://img.shields.io/github/last-commit/PreferredAI/cornac) [Cornac](https://github.com/PreferredAI/cornac) - A comparative framework for multimodal recommender systems with a focus on models leveraging auxiliary data.
* <code>&nbsp;17179</code> ![](https://img.shields.io/github/last-commit/google/jax) [JAX](https://github.com/google/jax) - JAX is Autograd and XLA, brought together for high-performance machine learning research.
* <code>&nbsp;&nbsp;2900</code> ![](https://img.shields.io/github/last-commit/catalyst-team/catalyst) [Catalyst](https://github.com/catalyst-team/catalyst) - High-level utils for PyTorch DL & RL research. It was developed with a focus on reproducibility, fast experimentation and code/ideas reusing. Being able to research/develop something new, rather than write another regular train loop.
* <code>&nbsp;22136</code> ![](https://img.shields.io/github/last-commit/fastai/fastai) [Fastai](https://github.com/fastai/fastai) - High-level wrapper built on the top of Pytorch which supports vision, text, tabular data and collaborative filtering.
* <code>&nbsp;&nbsp;&nbsp;618</code> ![](https://img.shields.io/github/last-commit/scikit-multiflow/scikit-multiflow) [scikit-multiflow](https://github.com/scikit-multiflow/scikit-multiflow) - A machine learning framework for multi-output/multi-label and stream data.
* <code>&nbsp;&nbsp;&nbsp;254</code> ![](https://img.shields.io/github/last-commit/mindsdb/lightwood) [Lightwood](https://github.com/mindsdb/lightwood) - A Pytorch based framework that breaks down machine learning problems into smaller blocks that can be glued together seamlessly with objective to build predictive models with one line of code.
* <code>&nbsp;&nbsp;&nbsp;&nbsp;68</code> ![](https://img.shields.io/github/last-commit/jungtaekkim/bayeso) [bayeso](https://github.com/jungtaekkim/bayeso) - A simple, but essential Bayesian optimization package, written in Python.
* <code>&nbsp;&nbsp;1866</code> ![](https://img.shields.io/github/last-commit/mljar/mljar-supervised) [mljar-supervised](https://github.com/mljar/mljar-supervised) - An Automated Machine Learning (AutoML) python package for tabular data. It can handle: Binary Classification, MultiClass Classification and Regression. It provides explanations and markdown reports.
* <code>&nbsp;&nbsp;&nbsp;246</code> ![](https://img.shields.io/github/last-commit/alirezamika/evostra) [evostra](https://github.com/alirezamika/evostra) - A fast Evolution Strategy implementation in Python.
* <code>&nbsp;&nbsp;1672</code> ![](https://img.shields.io/github/last-commit/determined-ai/determined) [Determined](https://github.com/determined-ai/determined) - Scalable deep learning training platform, including integrated support for distributed training, hyperparameter tuning, experiment tracking, and model management.
* <code>&nbsp;&nbsp;8052</code> ![](https://img.shields.io/github/last-commit/OpenMined/PySyft) [PySyft](https://github.com/OpenMined/PySyft) - A Python library for secure and private Deep Learning built on PyTorch and TensorFlow.
* <code>&nbsp;&nbsp;&nbsp;595</code> ![](https://img.shields.io/github/last-commit/OpenMined/PyGrid) [PyGrid](https://github.com/OpenMined/PyGrid/) - Peer-to-peer network of data owners and data scientists who can collectively train AI models using PySyft
* <code>&nbsp;&nbsp;5227</code> ![](https://img.shields.io/github/last-commit/alan-turing-institute/sktime) [sktime](https://github.com/alan-turing-institute/sktime) - A unified framework for machine learning with time series
* <code>&nbsp;&nbsp;&nbsp;&nbsp;24</code> ![](https://img.shields.io/github/last-commit/gugarosa/opfython) [OPFython](https://github.com/gugarosa/opfython) - A Python-inspired implementation of the Optimum-Path Forest classifier.
* <code>&nbsp;&nbsp;&nbsp;513</code> ![](https://img.shields.io/github/last-commit/gugarosa/opytimizer) [Opytimizer](https://github.com/gugarosa/opytimizer) - Python-based meta-heuristic optimization techniques.
* <code>&nbsp;&nbsp;5871</code> ![](https://img.shields.io/github/last-commit/gradio-app/gradio) [Gradio](https://github.com/gradio-app/gradio) - A Python library for quickly creating and sharing demos of models. Debug models interactively in your browser, get feedback from collaborators, and generate public links without deploying anything.
* <code>&nbsp;&nbsp;4423</code> ![](https://img.shields.io/github/last-commit/activeloopai/Hub) [Hub](https://github.com/activeloopai/Hub) - Fastest unstructured dataset management for TensorFlow/PyTorch. Stream & version-control data. Store even petabyte-scale data in a single numpy-like array on the cloud accessible on any machine. Visit [activeloop.ai](https://activeloop.ai) for more info.
* <code>&nbsp;&nbsp;&nbsp;&nbsp;28</code> ![](https://img.shields.io/github/last-commit/dmey/synthia) [Synthia](https://github.com/dmey/synthia) - Multidimensional synthetic data generation in Python.
* <code>&nbsp;&nbsp;&nbsp;&nbsp;43</code> ![](https://img.shields.io/github/last-commit/bytehub-ai/bytehub) [ByteHub](https://github.com/bytehub-ai/bytehub) - An easy-to-use, Python-based feature store. Optimized for time-series data.
* <code>&nbsp;&nbsp;&nbsp;225</code> ![](https://img.shields.io/github/last-commit/backprop-ai/backprop) [Backprop](https://github.com/backprop-ai/backprop) - Backprop makes it simple to use, finetune, and deploy state-of-the-art ML models.
* <code>&nbsp;&nbsp;3300</code> ![](https://img.shields.io/github/last-commit/online-ml/river) [River](https://github.com/online-ml/river): A framework for general purpose online machine learning.
* <code>&nbsp;&nbsp;&nbsp;366</code> ![](https://img.shields.io/github/last-commit/nccr-itmo/FEDOT) [FEDOT](https://github.com/nccr-itmo/FEDOT): An AutoML framework for the automated design of composite modeling pipelines. It can handle classification, regression, and time series forecasting tasks on different types of data (including multi-modal datasets).
* <code>&nbsp;&nbsp;&nbsp;&nbsp;97</code> ![](https://img.shields.io/github/last-commit/rodrigo-arenas/Sklearn-genetic-opt) [Sklearn-genetic-opt](https://github.com/rodrigo-arenas/Sklearn-genetic-opt): An AutoML package for hyperparameters tuning using evolutionary algorithms, with built-in callbacks, plotting, remote logging and more.
* <code>&nbsp;&nbsp;2279</code> ![](https://img.shields.io/github/last-commit/evidentlyai/evidently) [Evidently](https://github.com/evidentlyai/evidently): Interactive reports to analyze machine learning models during validation or production monitoring.
* <code>&nbsp;18650</code> ![](https://img.shields.io/github/last-commit/streamlit/streamlit) [Streamlit](https://github.com/streamlit/streamlit): Streamlit is an framework to create beautiful data apps in hours, not weeks.
* <code>&nbsp;&nbsp;6236</code> ![](https://img.shields.io/github/last-commit/optuna/optuna) [Optuna](https://github.com/optuna/optuna): Optuna is an automatic hyperparameter optimization software framework, particularly designed for machine learning.
* <code>&nbsp;&nbsp;1366</code> ![](https://img.shields.io/github/last-commit/deepchecks/deepchecks) [Deepchecks](https://github.com/deepchecks/deepchecks): Validation & testing of machine learning models and data during model development, deployment, and production. This includes checks and suites related to various types of issues, such as model performance, data integrity, distribution mismatches, and more.

<a name="python-data-analysis--data-visualization"></a>
#### Data Analysis / Data Visualization
* <code>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;8</code> ![](https://img.shields.io/github/last-commit/Shanky-21/Data_visualization) [DataVisualization](https://github.com/Shanky-21/Data_visualization) - A Github Repository Where you can Learn Datavisualizatoin Basics to Intermediate level.
...
* <code>&nbsp;&nbsp;2391</code> ![](https://img.shields.io/github/last-commit/mars-project/mars) [Mars](https://github.com/mars-project/mars) - A tensor-based framework for large-scale data computation which is often regarded as a parallel and distributed version of NumPy.
...
* <code>&nbsp;&nbsp;6998</code> ![](https://img.shields.io/github/last-commit/vaexio/vaex) [Vaex](https://github.com/vaexio/vaex) - A high performance Python library for lazy Out-of-Core DataFrames (similar to Pandas), to visualize and explore big tabular datasets. Documentation can be found [here](https://vaex.io/docs/index.html).
* <code>&nbsp;&nbsp;1182</code> ![](https://img.shields.io/github/last-commit/mining/mining) [Open Mining](https://github.com/mining/mining) - Business Intelligence (BI) in Python (Pandas web interface) **[Deprecated]**
* <code>&nbsp;&nbsp;6507</code> ![](https://img.shields.io/github/last-commit/pymc-devs/pymc) [PyMC](https://github.com/pymc-devs/pymc) - Markov Chain Monte Carlo sampling toolkit.
* <code>&nbsp;15061</code> ![](https://img.shields.io/github/last-commit/quantopian/zipline) [zipline](https://github.com/quantopian/zipline) - A Pythonic algorithmic trading library.
...
* <code>&nbsp;&nbsp;9056</code> ![](https://img.shields.io/github/last-commit/sympy/sympy) [SymPy](https://github.com/sympy/sympy) - A Python library for symbolic mathematics.
* <code>&nbsp;&nbsp;7282</code> ![](https://img.shields.io/github/last-commit/statsmodels/statsmodels) [statsmodels](https://github.com/statsmodels/statsmodels) - Statistical modeling and econometrics in Python.
* [astropy](https://www.astropy.org/) - A community Python library for Astronomy.
* [matplotlib](https://matplotlib.org/) - A Python 2D plotting library.
* <code>&nbsp;16191</code> ![](https://img.shields.io/github/last-commit/bokeh/bokeh) [bokeh](https://github.com/bokeh/bokeh) - Interactive Web Plotting for Python.
* [plotly](https://plot.ly/python/) - Collaborative web plotting for Python and matplotlib.
* <code>&nbsp;&nbsp;7420</code> ![](https://img.shields.io/github/last-commit/altair-viz/altair) [altair](https://github.com/altair-viz/altair) - A Python to Vega translator.
* <code>&nbsp;&nbsp;1391</code> ![](https://img.shields.io/github/last-commit/mikedewar/d3py) [d3py](https://github.com/mikedewar/d3py) - A plotting library for Python, based on [D3.js](https://d3js.org/).
* <code>&nbsp;&nbsp;&nbsp;&nbsp;31</code> ![](https://img.shields.io/github/last-commit/D3xterjs/pydexter) [PyDexter](https://github.com/D3xterjs/pydexter) - Simple plotting for Python. Wrapper for D3xterjs; easily render charts in-browser.
* <code>&nbsp;&nbsp;3614</code> ![](https://img.shields.io/github/last-commit/yhat/ggpy) [ggplot](https://github.com/yhat/ggpy) - Same API as ggplot2 for R. **[Deprecated]**
* <code>&nbsp;&nbsp;&nbsp;490</code> ![](https://img.shields.io/github/last-commit/sinhrks/ggfortify) [ggfortify](https://github.com/sinhrks/ggfortify) - Unified interface to ggplot2 popular R packages.
* <code>&nbsp;&nbsp;&nbsp;999</code> ![](https://img.shields.io/github/last-commit/kartograph/kartograph.py) [Kartograph.py](https://github.com/kartograph/kartograph.py) - Rendering beautiful SVG maps in Python.
* [pygal](http://pygal.org/en/stable/) - A Python SVG Charts Creator.
* <code>&nbsp;&nbsp;2777</code> ![](https://img.shields.io/github/last-commit/pyqtgraph/pyqtgraph) [PyQtGraph](https://github.com/pyqtgraph/pyqtgraph) - A pure-python graphics and GUI library built on PyQt4 / PySide and NumPy.
* <code>&nbsp;&nbsp;&nbsp;222</code> ![](https://img.shields.io/github/last-commit/twitter/pycascading) [pycascading](https://github.com/twitter/pycascading) **[Deprecated]**
* <code>&nbsp;&nbsp;&nbsp;247</code> ![](https://img.shields.io/github/last-commit/AirSage/Petrel) [Petrel](https://github.com/AirSage/Petrel) - Tools for writing, submitting, debugging, and monitoring Storm topologies in pure Python.
...
* <code>&nbsp;&nbsp;1214</code> ![](https://img.shields.io/github/last-commit/dfm/emcee) [emcee](https://github.com/dfm/emcee) - The Python ensemble sampling toolkit for affine-invariant MCMC.
* <code>&nbsp;&nbsp;&nbsp;120</code> ![](https://img.shields.io/github/last-commit/cigroup-ol/windml) [windML](https://github.com/cigroup-ol/windml) - A Python Framework for Wind Energy Analysis and Prediction.
* <code>&nbsp;&nbsp;2852</code> ![](https://img.shields.io/github/last-commit/vispy/vispy) [vispy](https://github.com/vispy/vispy) - GPU-based high-performance interactive OpenGL 2D/3D data visualization library.
* <code>&nbsp;&nbsp;&nbsp;&nbsp;24</code> ![](https://img.shields.io/github/last-commit/numenta/nupic.cerebro2) [cerebro2](https://github.com/numenta/nupic.cerebro2) A web-based visualization and debugging platform for NuPIC. **[Deprecated]**
* <code>&nbsp;&nbsp;&nbsp;&nbsp;92</code> ![](https://img.shields.io/github/last-commit/htm-community/nupic.studio) [NuPIC Studio](https://github.com/htm-community/nupic.studio) An all-in-one NuPIC Hierarchical Temporal Memory visualization and debugging super-tool! **[Deprecated]**
* <code>&nbsp;&nbsp;&nbsp;337</code> ![](https://img.shields.io/github/last-commit/sparklingpandas/sparklingpandas) [SparklingPandas](https://github.com/sparklingpandas/sparklingpandas) Pandas on PySpark (POPS).
* [Seaborn](https://seaborn.pydata.org/) - A python visualization library based on matplotlib.
* <code>&nbsp;&nbsp;&nbsp;&nbsp;41</code> ![](https://img.shields.io/github/last-commit/nicohlr/ipychart) [ipychart](https://github.com/nicohlr/ipychart) - The power of Chart.js in Jupyter Notebook.
* <code>&nbsp;&nbsp;3277</code> ![](https://img.shields.io/github/last-commit/bloomberg/bqplot) [bqplot](https://github.com/bloomberg/bqplot) - An API for plotting in Jupyter (IPython).
* <code>&nbsp;&nbsp;&nbsp;415</code> ![](https://img.shields.io/github/last-commit/rewonc/pastalog) [pastalog](https://github.com/rewonc/pastalog) - Simple, realtime visualization of neural network training performance.
* <code>&nbsp;45634</code> ![](https://img.shields.io/github/last-commit/apache/incubator-superset) [Superset](https://github.com/apache/incubator-superset) - A data exploration platform designed to be visual, intuitive, and interactive.
* <code>&nbsp;&nbsp;&nbsp;586</code> ![](https://img.shields.io/github/last-commit/nathanepstein/dora) [Dora](https://github.com/nathanepstein/dora) - Tools for exploratory data analysis in Python.
* [Ruffus](http://www.ruffus.org.uk) - Computation Pipeline library for python.
* <code>&nbsp;&nbsp;&nbsp;468</code> ![](https://img.shields.io/github/last-commit/sevamoo/SOMPY) [SOMPY](https://github.com/sevamoo/SOMPY) - Self Organizing Map written in Python (Uses neural networks for data analysis).
* <code>&nbsp;&nbsp;&nbsp;235</code> ![](https://img.shields.io/github/last-commit/peterwittek/somoclu) [somoclu](https://github.com/peterwittek/somoclu) Massively parallel self-organizing maps: accelerate training on multicore CPUs, GPUs, and clusters, has python API.
* <code>&nbsp;&nbsp;&nbsp;&nbsp;86</code> ![](https://img.shields.io/github/last-commit/lmcinnes/hdbscan) [HDBScan](https://github.com/lmcinnes/hdbscan) - implementation of the hdbscan algorithm in Python - used for clustering
* <code>&nbsp;&nbsp;&nbsp;161</code> ![](https://img.shields.io/github/last-commit/ayush1997/visualize_ML) [visualize_ML](https://github.com/ayush1997/visualize_ML) - A python package for data exploration and data analysis. **[Deprecated]**
* <code>&nbsp;&nbsp;2198</code> ![](https://img.shields.io/github/last-commit/reiinakano/scikit-plot) [scikit-plot](https://github.com/reiinakano/scikit-plot) - A visualization library for quick and easy generation of common plots in data analysis and machine learning.
* <code>&nbsp;&nbsp;&nbsp;745</code> ![](https://img.shields.io/github/last-commit/jwkvam/bowtie) [Bowtie](https://github.com/jwkvam/bowtie) - A dashboard library for interactive visualizations using flask socketio and react.
* <code>&nbsp;&nbsp;9709</code> ![](https://img.shields.io/github/last-commit/marcotcr/lime) [lime](https://github.com/marcotcr/lime) - Lime is about explaining what machine learning classifiers (or models) are doing. It is able to explain any black box classifier, with two or more classes.
* <code>&nbsp;&nbsp;1226</code> ![](https://img.shields.io/github/last-commit/sepandhaghighi/pycm) [PyCM](https://github.com/sepandhaghighi/pycm) - PyCM is a multi-class confusion matrix library written in Python that supports both input data vectors and direct matrix, and a proper tool for post-classification model evaluation that supports most classes and overall statistics parameters
* <code>&nbsp;16259</code> ![](https://img.shields.io/github/last-commit/plotly/dash) [Dash](https://github.com/plotly/dash) - A framework for creating analytical web applications built on top of Plotly.js, React, and Flask
* <code>&nbsp;&nbsp;&nbsp;&nbsp;12</code> ![](https://img.shields.io/github/last-commit/asavinov/lambdo) [Lambdo](https://github.com/asavinov/lambdo) - A workflow engine for solving machine learning problems by combining in one analysis pipeline (i) feature engineering and machine learning (ii) model training and prediction (iii) table population and column evaluation via user-defined (Python) functions.
* <code>&nbsp;&nbsp;3217</code> ![](https://img.shields.io/github/last-commit/microsoft/tensorwatch) [TensorWatch](https://github.com/microsoft/tensorwatch) - Debugging and visualization tool for machine learning and data science. It extensively leverages Jupyter Notebook to show real-time visualizations of data in running processes such as machine learning training.
* <code>&nbsp;&nbsp;&nbsp;&nbsp;24</code> ![](https://img.shields.io/github/last-commit/rlworkgroup/dowel) [dowel](https://github.com/rlworkgroup/dowel) - A little logger for machine learning research. Output any object to the terminal, CSV, TensorBoard, text logs on disk, and more with just one call to `logger.log()`.

<a name="python-misc-scripts--ipython-notebooks--codebases"></a>
#### Misc Scripts / iPython Notebooks / Codebases
* <code>&nbsp;&nbsp;&nbsp;&nbsp;73</code> ![](https://img.shields.io/github/last-commit/kennysong/minigrad) [MiniGrad](https://github.com/kennysong/minigrad) – A minimal, educational, Pythonic implementation of autograd (~100 loc).
* <code>&nbsp;&nbsp;&nbsp;&nbsp;56</code> ![](https://img.shields.io/github/last-commit/Yannael/BigDataAnalytics_INFOH515) [Map/Reduce implementations of common ML algorithms](https://github.com/Yannael/BigDataAnalytics_INFOH515): Jupyter notebooks that cover how to implement from scratch different ML algorithms (ordinary least squares, gradient descent, k-means, alternating least squares), using Python NumPy, and how to then make these implementations scalable using Map/Reduce and Spark.
* <code>&nbsp;&nbsp;&nbsp;&nbsp;39</code> ![](https://img.shields.io/github/last-commit/jaredthecoder/BioPy) [BioPy](https://github.com/jaredthecoder/BioPy) - Biologically-Inspired and Machine Learning Algorithms in Python. **[Deprecated]**
* <code>&nbsp;&nbsp;&nbsp;&nbsp;17</code> ![](https://img.shields.io/github/last-commit/julianmack/Data_Assimilation) [CAEs for Data Assimilation](https://github.com/julianmack/Data_Assimilation) - Convolutional autoencoders for 3D image/field compression applied to reduced order [Data Assimilation](https://en.wikipedia.org/wiki/Data_assimilation).
* <code>&nbsp;24270</code> ![](https://img.shields.io/github/last-commit/ageron/handson-ml) [handsonml](https://github.com/ageron/handson-ml) - Fundamentals of machine learning in python.
* <code>&nbsp;&nbsp;&nbsp;150</code> ![](https://img.shields.io/github/last-commit/plotly/dash-svm) [SVM Explorer](https://github.com/plotly/dash-svm) - Interactive SVM Explorer, using Dash and scikit-learn
* <code>&nbsp;&nbsp;3919</code> ![](https://img.shields.io/github/last-commit/rasbt/pattern_classification) [pattern_classification](https://github.com/rasbt/pattern_classification)
* <code>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;8</code> ![](https://img.shields.io/github/last-commit/Wavelets/ThinkStats2) [thinking stats 2](https://github.com/Wavelets/ThinkStats2)
* <code>&nbsp;&nbsp;1318</code> ![](https://img.shields.io/github/last-commit/hyperopt/hyperopt-sklearn) [hyperopt](https://github.com/hyperopt/hyperopt-sklearn)
* <code>&nbsp;&nbsp;6300</code> ![](https://img.shields.io/github/last-commit/numenta/nupic) [numpic](https://github.com/numenta/nupic)
* <code>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;8</code> ![](https://img.shields.io/github/last-commit/dib-lab/2012-paper-diginorm) [2012-paper-diginorm](https://github.com/dib-lab/2012-paper-diginorm)
* <code>&nbsp;13391</code> ![](https://img.shields.io/github/last-commit/jupyter/jupyter) [A gallery of interesting IPython notebooks](https://github.com/jupyter/jupyter/wiki/A-gallery-of-interesting-Jupyter-Notebooks)
* <code>&nbsp;&nbsp;&nbsp;548</code> ![](https://img.shields.io/github/last-commit/ogrisel/notebooks) [ipython-notebooks](https://github.com/ogrisel/notebooks)
* <code>&nbsp;22957</code> ![](https://img.shields.io/github/last-commit/donnemartin/data-science-ipython-notebooks) [data-science-ipython-notebooks](https://github.com/donnemartin/data-science-ipython-notebooks) - Continually updated Data Science Python Notebooks: Spark, Hadoop MapReduce, HDFS, AWS, Kaggle, scikit-learn, matplotlib, pandas, NumPy, SciPy, and various command lines.
* <code>&nbsp;&nbsp;&nbsp;&nbsp;32</code> ![](https://img.shields.io/github/last-commit/CamDavidsonPilon/decision-weights) [decision-weights](https://github.com/CamDavidsonPilon/decision-weights)
* <code>&nbsp;&nbsp;&nbsp;&nbsp;10</code> ![](https://img.shields.io/github/last-commit/Wavelets/sarah-palin-lda) [Sarah Palin LDA](https://github.com/Wavelets/sarah-palin-lda) - Topic Modeling the Sarah Palin emails.
* <code>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;2</code> ![](https://img.shields.io/github/last-commit/Wavelets/diffusion-segmentation) [Diffusion Segmentation](https://github.com/Wavelets/diffusion-segmentation) - A collection of image segmentation algorithms based on diffusion methods.
* <code>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;2</code> ![](https://img.shields.io/github/last-commit/Wavelets/scipy-tutorials) [Scipy Tutorials](https://github.com/Wavelets/scipy-tutorials) - SciPy tutorials. This is outdated, check out scipy-lecture-notes.
* <code>&nbsp;&nbsp;&nbsp;&nbsp;85</code> ![](https://img.shields.io/github/last-commit/marcelcaraciolo/crab) [Crab](https://github.com/marcelcaraciolo/crab) - A recommendation engine library for Python.
* <code>&nbsp;&nbsp;&nbsp;&nbsp;94</code> ![](https://img.shields.io/github/last-commit/maxsklar/BayesPy) [BayesPy](https://github.com/maxsklar/BayesPy) - Bayesian Inference Tools in Python.
* <code>&nbsp;&nbsp;&nbsp;116</code> ![](https://img.shields.io/github/last-commit/GaelVaroquaux/scikit-learn-tutorial) [scikit-learn tutorials](https://github.com/GaelVaroquaux/scikit-learn-tutorial) - Series of notebooks for learning scikit-learn.
* <code>&nbsp;&nbsp;&nbsp;&nbsp;53</code> ![](https://img.shields.io/github/last-commit/madhusudancs/sentiment-analyzer) [sentiment-analyzer](https://github.com/madhusudancs/sentiment-analyzer) - Tweets Sentiment Analyzer
* <code>&nbsp;&nbsp;&nbsp;171</code> ![](https://img.shields.io/github/last-commit/kevincobain2000/sentiment_classifier) [sentiment_classifier](https://github.com/kevincobain2000/sentiment_classifier) - Sentiment classifier using word sense disambiguation.
* <code>&nbsp;&nbsp;&nbsp;&nbsp;37</code> ![](https://img.shields.io/github/last-commit/fabianp/group_lasso) [group-lasso](https://github.com/fabianp/group_lasso) - Some experiments with the coordinate descent algorithm used in the (Sparse) Group Lasso model.
* <code>&nbsp;&nbsp;&nbsp;142</code> ![](https://img.shields.io/github/last-commit/kevincobain2000/jProcessing) [jProcessing](https://github.com/kevincobain2000/jProcessing) - Kanji / Hiragana / Katakana to Romaji Converter. Edict Dictionary & parallel sentences Search. Sentence Similarity between two JP Sentences. Sentiment Analysis of Japanese Text. Run Cabocha(ISO--8859-1 configured) in Python.
* <code>&nbsp;&nbsp;&nbsp;&nbsp;21</code> ![](https://img.shields.io/github/last-commit/mne-tools/mne-python-notebooks) [mne-python-notebooks](https://github.com/mne-tools/mne-python-notebooks) - IPython notebooks for EEG/MEG data processing using mne-python.
* <code>&nbsp;&nbsp;&nbsp;&nbsp;91</code> ![](https://img.shields.io/github/last-commit/NervanaSystems/neon_course) [Neon Course](https://github.com/NervanaSystems/neon_course) - IPython notebooks for a complete course around understanding Nervana's Neon.
* <code>&nbsp;&nbsp;5699</code> ![](https://img.shields.io/github/last-commit/jvns/pandas-cookbook) [pandas cookbook](https://github.com/jvns/pandas-cookbook) - Recipes for using Python's pandas library.
* <code>&nbsp;&nbsp;&nbsp;178</code> ![](https://img.shields.io/github/last-commit/BRML/climin) [climin](https://github.com/BRML/climin) - Optimization library focused on machine learning, pythonic implementations of gradient descent, LBFGS, rmsprop, adadelta and others.
* <code>&nbsp;&nbsp;&nbsp;&nbsp;37</code> ![](https://img.shields.io/github/last-commit/AllenDowney/DataScience) [Allen Downey’s Data Science Course](https://github.com/AllenDowney/DataScience) - Code for Data Science at Olin College, Spring 2014.
* <code>&nbsp;&nbsp;1573</code> ![](https://img.shields.io/github/last-commit/AllenDowney/ThinkBayes) [Allen Downey’s Think Bayes Code](https://github.com/AllenDowney/ThinkBayes) - Code repository for Think Bayes.
* <code>&nbsp;&nbsp;&nbsp;&nbsp;89</code> ![](https://img.shields.io/github/last-commit/AllenDowney/ThinkComplexity) [Allen Downey’s Think Complexity Code](https://github.com/AllenDowney/ThinkComplexity) - Code for Allen Downey's book Think Complexity.
* <code>&nbsp;&nbsp;&nbsp;490</code> ![](https://img.shields.io/github/last-commit/AllenDowney/ThinkOS) [Allen Downey’s Think OS Code](https://github.com/AllenDowney/ThinkOS) - Text and supporting code for Think OS: A Brief Introduction to Operating Systems.
...
* <code>&nbsp;10966</code> ![](https://img.shields.io/github/last-commit/hangtwenty/dive-into-machine-learning) [Dive into Machine Learning  with Python Jupyter notebook and scikit-learn](https://github.com/hangtwenty/dive-into-machine-learning) - "I learned Python by hacking first, and getting serious *later.* I wanted to do this with Machine Learning. If this is your style, join me in getting a bit ahead of yourself."
* <code>&nbsp;&nbsp;1364</code> ![](https://img.shields.io/github/last-commit/ericjang/tdb) [TDB](https://github.com/ericjang/tdb) - TensorDebugger (TDB) is a visual debugger for deep learning. It features interactive, node-by-node debugging and visualization for TensorFlow.
* <code>&nbsp;&nbsp;&nbsp;704</code> ![](https://img.shields.io/github/last-commit/kendricktan/suiron) [Suiron](https://github.com/kendricktan/suiron/) - Machine Learning for RC Cars.
* <code>&nbsp;&nbsp;3347</code> ![](https://img.shields.io/github/last-commit/justmarkham/scikit-learn-videos) [Introduction to machine learning with scikit-learn](https://github.com/justmarkham/scikit-learn-videos) - IPython notebooks from Data School's video tutorials on scikit-learn.
...
* <code>&nbsp;&nbsp;6051</code> ![](https://img.shields.io/github/last-commit/amueller/introduction_to_ml_with_python) [Introduction to Machine Learning with Python](https://github.com/amueller/introduction_to_ml_with_python) - Notebooks and code for the book "Introduction to Machine Learning with Python"
* <code>&nbsp;16959</code> ![](https://img.shields.io/github/last-commit/wesm/pydata-book) [Pydata book](https://github.com/wesm/pydata-book) - Materials and IPython notebooks for "Python for Data Analysis" by Wes McKinney, published by O'Reilly Media
* <code>&nbsp;19154</code> ![](https://img.shields.io/github/last-commit/trekhleb/homemade-machine-learning) [Homemade Machine Learning](https://github.com/trekhleb/homemade-machine-learning) - Python examples of popular machine learning algorithms with interactive Jupyter demos and math being explained
* <code>&nbsp;&nbsp;&nbsp;&nbsp;49</code> ![](https://img.shields.io/github/last-commit/prodmodel/prodmodel) [Prodmodel](https://github.com/prodmodel/prodmodel) - Build tool for data science pipelines.
* <code>&nbsp;&nbsp;&nbsp;340</code> ![](https://img.shields.io/github/last-commit/maitbayev/the-elements-of-statistical-learning) [the-elements-of-statistical-learning](https://github.com/maitbayev/the-elements-of-statistical-learning) - This repository contains Jupyter notebooks implementing the algorithms found in the book and summary of the textbook.
* <code>&nbsp;&nbsp;&nbsp;872</code> ![](https://img.shields.io/github/last-commit/LiYangHart/Hyperparameter-Optimization-of-Machine-Learning-Algorithms) [Hyperparameter-Optimization-of-Machine-Learning-Algorithms](https://github.com/LiYangHart/Hyperparameter-Optimization-of-Machine-Learning-Algorithms) - Code for hyperparameter tuning/optimization of machine learning and deep learning algorithms.
...
* <code>&nbsp;&nbsp;2502</code> ![](https://img.shields.io/github/last-commit/keras-team/keras-tuner) [Keras Tuner](https://github.com/keras-team/keras-tuner) - An easy-to-use, scalable hyperparameter optimization framework that solves the pain points of hyperparameter search.
...
* <code>&nbsp;&nbsp;&nbsp;145</code> ![](https://img.shields.io/github/last-commit/p-christ/nn_builder) [nn_builder](https://github.com/p-christ/nn_builder) - nn_builder is a python package that lets you build neural networks in 1 line
* <code>&nbsp;&nbsp;5260</code> ![](https://img.shields.io/github/last-commit/karpathy/neuraltalk) [NeuralTalk](https://github.com/karpathy/neuraltalk) - NeuralTalk is a Python+numpy project for learning Multimodal Recurrent Neural Networks that describe images with sentences.
* <code>&nbsp;&nbsp;&nbsp;&nbsp;36</code> ![](https://img.shields.io/github/last-commit/molcik/python-neuron) [Neuron](https://github.com/molcik/python-neuron) - Neuron is simple class for time series predictions. It's utilize LNU (Linear Neural Unit), QNU (Quadratic Neural Unit), RBF (Radial Basis Function), MLP (Multi Layer Perceptron), MLP-ELM (Multi Layer Perceptron - Extreme Learning Machine) neural networks learned with Gradient descent or LeLevenberg–Marquardt algorithm.

* <code>&nbsp;&nbsp;5283</code> ![](https://img.shields.io/github/last-commit/karpathy/neuraltalk2) [NeuralTalk](https://github.com/karpathy/neuraltalk2) - NeuralTalk is a Python+numpy project for learning Multimodal Recurrent Neural Networks that describe images with sentences. **[Deprecated]**
* <code>&nbsp;&nbsp;&nbsp;&nbsp;36</code> ![](https://img.shields.io/github/last-commit/molcik/python-neuron) [Neuron](https://github.com/molcik/python-neuron) - Neuron is simple class for time series predictions. It's utilize LNU (Linear Neural Unit), QNU (Quadratic Neural Unit), RBF (Radial Basis Function), MLP (Multi Layer Perceptron), MLP-ELM (Multi Layer Perceptron - Extreme Learning Machine) neural networks learned with Gradient descent or LeLevenberg–Marquardt algorithm. **[Deprecated]**
* <code>&nbsp;&nbsp;&nbsp;&nbsp;26</code> ![](https://img.shields.io/github/last-commit/atmb4u/data-driven-code) [Data Driven Code](https://github.com/atmb4u/data-driven-code) - Very simple implementation of neural networks for dummies in python without using any libraries, with detailed comments.
...
* <code>&nbsp;&nbsp;&nbsp;408</code> ![](https://img.shields.io/github/last-commit/mrT23/TResNet) [TResNet: High Performance GPU-Dedicated Architecture](https://github.com/mrT23/TResNet) - TResNet models were designed and optimized to give the best speed-accuracy tradeoff out there on GPUs.
* <code>&nbsp;&nbsp;&nbsp;151</code> ![](https://img.shields.io/github/last-commit/zueve/neurolab) [TResNet: Simple and powerful neural network library for python](https://github.com/zueve/neurolab) - Variety of supported types of Artificial Neural Network and learning algorithms.
* [Jina AI](https://jina.ai/) An easier way to build neural search in the cloud. Compatible with Jupyter Notebooks.
* <code>&nbsp;&nbsp;&nbsp;250</code> ![](https://img.shields.io/github/last-commit/shobrook/sequitur) [sequitur](https://github.com/shobrook/sequitur) PyTorch library for creating and training sequence autoencoders in just two lines of code

<a name="python-survival-analysis"></a>
#### Python Survival Analysis
* <code>&nbsp;&nbsp;1848</code> ![](https://img.shields.io/github/last-commit/CamDavidsonPilon/lifelines) [lifelines](https://github.com/CamDavidsonPilon/lifelines) - lifelines is a complete survival analysis library, written in pure Python
* <code>&nbsp;&nbsp;&nbsp;746</code> ![](https://img.shields.io/github/last-commit/sebp/scikit-survival) [Scikit-Survival](https://github.com/sebp/scikit-survival) - scikit-survival is a Python module for survival analysis built on top of scikit-learn. It allows doing survival analysis while utilizing the power of scikit-learn, e.g., for pre-processing or doing cross-validation.
...
* <code>&nbsp;&nbsp;8052</code> ![](https://img.shields.io/github/last-commit/OpenMined/PySyft) [PySyft](https://github.com/OpenMined/PySyft) - A Python library for secure and private Deep Learning.
...
* <code>&nbsp;&nbsp;&nbsp;159</code> ![](https://img.shields.io/github/last-commit/neptune-ml/open-solution-data-science-bowl-2018) [open-solution-data-science-bowl-2018](https://github.com/neptune-ml/open-solution-data-science-bowl-2018) -> source code and [experiments results](https://app.neptune.ml/neptune-ml/Data-Science-Bowl-2018) for [2018 Data Science Bowl](https://www.kaggle.com/c/data-science-bowl-2018).
* <code>&nbsp;&nbsp;&nbsp;&nbsp;35</code> ![](https://img.shields.io/github/last-commit/neptune-ml/open-solution-value-prediction) [open-solution-value-prediction](https://github.com/neptune-ml/open-solution-value-prediction) -> source code and [experiments results](https://app.neptune.ml/neptune-ml/Santander-Value-Prediction-Challenge) for [Santander Value Prediction Challenge](https://www.kaggle.com/c/santander-value-prediction-challenge).
* <code>&nbsp;&nbsp;&nbsp;153</code> ![](https://img.shields.io/github/last-commit/neptune-ml/open-solution-toxic-comments) [open-solution-toxic-comments](https://github.com/neptune-ml/open-solution-toxic-comments) -> source code for [Toxic Comment Classification Challenge](https://www.kaggle.com/c/jigsaw-toxic-comment-classification-challenge).
* <code>&nbsp;&nbsp;&nbsp;&nbsp;12</code> ![](https://img.shields.io/github/last-commit/hammer/wikichallenge) [wiki challenge](https://github.com/hammer/wikichallenge) - An implementation of Dell Zhang's solution to Wikipedia's Participation Challenge on Kaggle.
* <code>&nbsp;&nbsp;&nbsp;155</code> ![](https://img.shields.io/github/last-commit/amueller/kaggle_insults) [kaggle insults](https://github.com/amueller/kaggle_insults) - Kaggle Submission for "Detecting Insults in Social Commentary".
* <code>&nbsp;&nbsp;&nbsp;&nbsp;68</code> ![](https://img.shields.io/github/last-commit/MLWave/kaggle_acquire-valued-shoppers-challenge) [kaggle_acquire-valued-shoppers-challenge](https://github.com/MLWave/kaggle_acquire-valued-shoppers-challenge) - Code for the Kaggle acquire valued shoppers challenge.
* <code>&nbsp;&nbsp;&nbsp;&nbsp;45</code> ![](https://img.shields.io/github/last-commit/zygmuntz/kaggle-cifar) [kaggle-cifar](https://github.com/zygmuntz/kaggle-cifar) - Code for the CIFAR-10 competition at Kaggle, uses cuda-convnet.
* <code>&nbsp;&nbsp;&nbsp;117</code> ![](https://img.shields.io/github/last-commit/zygmuntz/kaggle-blackbox) [kaggle-blackbox](https://github.com/zygmuntz/kaggle-blackbox) - Deep learning made easy.
* <code>&nbsp;&nbsp;&nbsp;&nbsp;16</code> ![](https://img.shields.io/github/last-commit/zygmuntz/kaggle-accelerometer) [kaggle-accelerometer](https://github.com/zygmuntz/kaggle-accelerometer) - Code for Accelerometer Biometric Competition at Kaggle.
* <code>&nbsp;&nbsp;&nbsp;&nbsp;57</code> ![](https://img.shields.io/github/last-commit/zygmuntz/kaggle-advertised-salaries) [kaggle-advertised-salaries](https://github.com/zygmuntz/kaggle-advertised-salaries) - Predicting job salaries from ads - a Kaggle competition.
* <code>&nbsp;&nbsp;&nbsp;&nbsp;27</code> ![](https://img.shields.io/github/last-commit/zygmuntz/kaggle-amazon) [kaggle amazon](https://github.com/zygmuntz/kaggle-amazon) - Amazon access control challenge.
* <code>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;9</code> ![](https://img.shields.io/github/last-commit/zygmuntz/kaggle-bestbuy_big) [kaggle-bestbuy_big](https://github.com/zygmuntz/kaggle-bestbuy_big) - Code for the Best Buy competition at Kaggle.
* <code>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;7</code> ![](https://img.shields.io/github/last-commit/zygmuntz/kaggle-bestbuy_small) [kaggle-bestbuy_small](https://github.com/zygmuntz/kaggle-bestbuy_small)
* <code>&nbsp;&nbsp;&nbsp;&nbsp;68</code> ![](https://img.shields.io/github/last-commit/kastnerkyle/kaggle-dogs-vs-cats) [Kaggle Dogs vs. Cats](https://github.com/kastnerkyle/kaggle-dogs-vs-cats) - Code for Kaggle Dogs vs. Cats competition.
* <code>&nbsp;&nbsp;&nbsp;482</code> ![](https://img.shields.io/github/last-commit/benanne/kaggle-galaxies) [Kaggle Galaxy Challenge](https://github.com/benanne/kaggle-galaxies) - Winning solution for the Galaxy Challenge on Kaggle.
* <code>&nbsp;&nbsp;&nbsp;&nbsp;20</code> ![](https://img.shields.io/github/last-commit/zygmuntz/kaggle-gender) [Kaggle Gender](https://github.com/zygmuntz/kaggle-gender) - A Kaggle competition: discriminate gender based on handwriting.
* <code>&nbsp;&nbsp;&nbsp;&nbsp;10</code> ![](https://img.shields.io/github/last-commit/zygmuntz/kaggle-merck) [Kaggle Merck](https://github.com/zygmuntz/kaggle-merck) - Merck challenge at Kaggle.
* <code>&nbsp;&nbsp;&nbsp;&nbsp;47</code> ![](https://img.shields.io/github/last-commit/zygmuntz/kaggle-stackoverflow) [Kaggle Stackoverflow](https://github.com/zygmuntz/kaggle-stackoverflow) - Predicting closed questions on Stack Overflow.
* <code>&nbsp;&nbsp;&nbsp;&nbsp;68</code> ![](https://img.shields.io/github/last-commit/MLWave/kaggle_acquire-valued-shoppers-challenge) [kaggle_acquire-valued-shoppers-challenge](https://github.com/MLWave/kaggle_acquire-valued-shoppers-challenge) - Code for the Kaggle acquire valued shoppers challenge.
* <code>&nbsp;&nbsp;&nbsp;&nbsp;22</code> ![](https://img.shields.io/github/last-commit/zygmuntz/wine-quality) [wine-quality](https://github.com/zygmuntz/wine-quality) - Predicting wine quality.

<a name="python-reinforcement-learning"></a>
#### Reinforcement Learning
* <code>&nbsp;&nbsp;6658</code> ![](https://img.shields.io/github/last-commit/deepmind/lab) [DeepMind Lab](https://github.com/deepmind/lab) - DeepMind Lab is a 3D learning environment based on id Software's Quake III Arena via ioquake3 and other open source software. Its primary purpose is to act as a testbed for research in artificial intelligence, especially deep reinforcement learning.
* <code>&nbsp;27236</code> ![](https://img.shields.io/github/last-commit/openai/gym) [Gym](https://github.com/openai/gym) - OpenAI Gym is a toolkit for developing and comparing reinforcement learning algorithms.
* <code>&nbsp;&nbsp;6227</code> ![](https://img.shields.io/github/last-commit/SerpentAI/SerpentAI) [Serpent.AI](https://github.com/SerpentAI/SerpentAI) - Serpent.AI is a game agent framework that allows you to turn any video game you own into a sandbox to develop AI and machine learning experiments. For both researchers and hobbyists.
* <code>&nbsp;&nbsp;1351</code> ![](https://img.shields.io/github/last-commit/mwydmuch/ViZDoom) [ViZDoom](https://github.com/mwydmuch/ViZDoom) - ViZDoom allows developing AI bots that play Doom using only the visual information (the screen buffer). It is primarily intended for research in machine visual learning, and deep reinforcement learning, in particular.
* <code>&nbsp;&nbsp;2016</code> ![](https://img.shields.io/github/last-commit/openai/roboschool) [Roboschool](https://github.com/openai/roboschool) - Open-source software for robot simulation, integrated with OpenAI Gym.
* <code>&nbsp;&nbsp;2633</code> ![](https://img.shields.io/github/last-commit/openai/retro) [Retro](https://github.com/openai/retro) - Retro Games in Gym
* <code>&nbsp;&nbsp;1043</code> ![](https://img.shields.io/github/last-commit/kengz/SLM-Lab) [SLM Lab](https://github.com/kengz/SLM-Lab) - Modular Deep Reinforcement Learning framework in PyTorch.
* <code>&nbsp;&nbsp;2136</code> ![](https://img.shields.io/github/last-commit/NervanaSystems/coach) [Coach](https://github.com/NervanaSystems/coach) - Reinforcement Learning Coach by Intel® AI Lab enables easy experimentation with state of the art Reinforcement Learning algorithms
* <code>&nbsp;&nbsp;1429</code> ![](https://img.shields.io/github/last-commit/rlworkgroup/garage) [garage](https://github.com/rlworkgroup/garage) - A toolkit for reproducible reinforcement learning research
* <code>&nbsp;&nbsp;&nbsp;672</code> ![](https://img.shields.io/github/last-commit/rlworkgroup/metaworld) [metaworld](https://github.com/rlworkgroup/metaworld) - An open source robotics benchmark for meta- and multi-task reinforcement learning
...
* <code>&nbsp;&nbsp;&nbsp;205</code> ![](https://img.shields.io/github/last-commit/enlite-ai/maze) [Maze](https://github.com/enlite-ai/maze) - Application-oriented deep reinforcement learning framework addressing real-world decision problems.
* <code>&nbsp;19964</code> ![](https://img.shields.io/github/last-commit/ray-project/ray) [RLlib](https://github.com/ray-project/ray) - RLlib is an industry level, highly scalable RL library for tf and torch, based on Ray. It's used by companies like Amazon and Microsoft to solve real-world decision making problems at scale.
...
* <code>&nbsp;&nbsp;&nbsp;942</code> ![](https://img.shields.io/github/last-commit/arbox/nlp-with-ruby) [Awesome NLP with Ruby](https://github.com/arbox/nlp-with-ruby) - Curated link list for practical natural language processing in Ruby.
* <code>&nbsp;&nbsp;1353</code> ![](https://img.shields.io/github/last-commit/louismullie/treat) [Treat](https://github.com/louismullie/treat) - Text REtrieval and Annotation Toolkit, definitely the most comprehensive toolkit I’ve encountered so far for Ruby.
* <code>&nbsp;&nbsp;&nbsp;255</code> ![](https://img.shields.io/github/last-commit/aurelian/ruby-stemmer) [Stemmer](https://github.com/aurelian/ruby-stemmer) - Expose libstemmer_c to Ruby. **[Deprecated]**
* [Raspell](https://sourceforge.net/projects/raspell/) - raspell is an interface binding for ruby. **[Deprecated]**
* <code>&nbsp;&nbsp;&nbsp;&nbsp;50</code> ![](https://img.shields.io/github/last-commit/ealdent/uea-stemmer) [UEA Stemmer](https://github.com/ealdent/uea-stemmer) - Ruby port of UEALite Stemmer - a conservative stemmer for search and indexing.
* <code>&nbsp;&nbsp;2712</code> ![](https://img.shields.io/github/last-commit/twitter/twitter-text) [Twitter-text-rb](https://github.com/twitter/twitter-text/tree/master/rb) - A library that does auto linking and extraction of usernames, lists and hashtags in tweets.

<a name="ruby-general-purpose-machine-learning"></a>
#### General-Purpose Machine Learning

* <code>&nbsp;&nbsp;1742</code> ![](https://img.shields.io/github/last-commit/arbox/machine-learning-with-ruby) [Awesome Machine Learning with Ruby](https://github.com/arbox/machine-learning-with-ruby) - Curated list of ML related resources for Ruby.
* <code>&nbsp;&nbsp;&nbsp;&nbsp;32</code> ![](https://img.shields.io/github/last-commit/tsycho/ruby-machine-learning) [Ruby Machine Learning](https://github.com/tsycho/ruby-machine-learning) - Some Machine Learning algorithms, implemented in Ruby. **[Deprecated]**
* <code>&nbsp;&nbsp;&nbsp;&nbsp;15</code> ![](https://img.shields.io/github/last-commit/mizoR/machine-learning-ruby) [Machine Learning Ruby](https://github.com/mizoR/machine-learning-ruby) **[Deprecated]**
* <code>&nbsp;&nbsp;&nbsp;164</code> ![](https://img.shields.io/github/last-commit/vasinov/jruby_mahout) [jRuby Mahout](https://github.com/vasinov/jruby_mahout) - JRuby Mahout is a gem that unleashes the power of Apache Mahout in the world of JRuby. **[Deprecated]**
* <code>&nbsp;&nbsp;&nbsp;649</code> ![](https://img.shields.io/github/last-commit/cardmagic/classifier) [CardMagic-Classifier](https://github.com/cardmagic/classifier) - A general classifier module to allow Bayesian and other types of classifications.
* <code>&nbsp;&nbsp;&nbsp;277</code> ![](https://img.shields.io/github/last-commit/febeling/rb-libsvm) [rb-libsvm](https://github.com/febeling/rb-libsvm) - Ruby language bindings for LIBSVM which is a Library for Support Vector Machines.
* <code>&nbsp;&nbsp;&nbsp;&nbsp;69</code> ![](https://img.shields.io/github/last-commit/asafschers/scoruby) [Scoruby](https://github.com/asafschers/scoruby) - Creates Random Forest classifiers from PMML files.
* <code>&nbsp;&nbsp;&nbsp;598</code> ![](https://img.shields.io/github/last-commit/yoshoku/rumale) [rumale](https://github.com/yoshoku/rumale) - Rumale is a machine learning library in Ruby

<a name="ruby-data-analysis--data-visualization"></a>
#### Data Analysis / Data Visualization

* <code>&nbsp;&nbsp;&nbsp;330</code> ![](https://img.shields.io/github/last-commit/alexgutteridge/rsruby) [rsruby](https://github.com/alexgutteridge/rsruby) - Ruby - R bridge.
* <code>&nbsp;&nbsp;&nbsp;&nbsp;68</code> ![](https://img.shields.io/github/last-commit/chrislo/data_visualisation_ruby) [data-visualization-ruby](https://github.com/chrislo/data_visualisation_ruby) - Source code and supporting content for my Ruby Manor presentation on Data Visualisation with Ruby. **[Deprecated]**
...
* <code>&nbsp;&nbsp;&nbsp;&nbsp;41</code> ![](https://img.shields.io/github/last-commit/zuhao/plotrb) [plot-rb](https://github.com/zuhao/plotrb) - A plotting library in Ruby built on top of Vega and D3. **[Deprecated]**
* <code>&nbsp;&nbsp;&nbsp;&nbsp;33</code> ![](https://img.shields.io/github/last-commit/delano/scruffy) [scruffy](https://github.com/delano/scruffy) - A beautiful graphing toolkit for Ruby.
* [SciRuby](http://sciruby.com/)
* <code>&nbsp;&nbsp;&nbsp;114</code> ![](https://img.shields.io/github/last-commit/glean/glean) [Glean](https://github.com/glean/glean) - A data management tool for humans. **[Deprecated]**
* <code>&nbsp;&nbsp;&nbsp;364</code> ![](https://img.shields.io/github/last-commit/bioruby/bioruby) [Bioruby](https://github.com/bioruby/bioruby)
* <code>&nbsp;&nbsp;&nbsp;265</code> ![](https://img.shields.io/github/last-commit/nkallen/arel) [Arel](https://github.com/nkallen/arel) **[Deprecated]**

<a name="ruby-misc"></a>
#### Misc

* <code>&nbsp;&nbsp;&nbsp;168</code> ![](https://img.shields.io/github/last-commit/infochimps-labs/big_data_for_chimps) [Big Data For Chimps](https://github.com/infochimps-labs/big_data_for_chimps)
* <code>&nbsp;&nbsp;&nbsp;&nbsp;26</code> ![](https://img.shields.io/github/last-commit/kevincobain2000/listof) [Listof](https://github.com/kevincobain2000/listof) - Community based data collection, packed in gem. Get list of pretty much anything (stop words, countries, non words) in txt, json or hash. [Demo/Search for a list](http://kevincobain2000.github.io/listof/)
...
#### General-Purpose Machine Learning
* <code>&nbsp;&nbsp;&nbsp;233</code> ![](https://img.shields.io/github/last-commit/smartcorelib/smartcore) [smartcore](https://github.com/smartcorelib/smartcore) - "The Most Advanced Machine Learning Library In Rust."
* <code>&nbsp;&nbsp;1623</code> ![](https://img.shields.io/github/last-commit/rust-ml/linfa) [linfa](https://github.com/rust-ml/linfa) - a comprehensive toolkit to build Machine Learning applications with Rust
* <code>&nbsp;&nbsp;&nbsp;194</code> ![](https://img.shields.io/github/last-commit/tedsta/deeplearn-rs) [deeplearn-rs](https://github.com/tedsta/deeplearn-rs) - deeplearn-rs provides simple networks that use matrix multiplication, addition, and ReLU under the MIT license.
* <code>&nbsp;&nbsp;&nbsp;521</code> ![](https://img.shields.io/github/last-commit/maciejkula/rustlearn) [rustlearn](https://github.com/maciejkula/rustlearn) - a machine learning framework featuring logistic regression, support vector machines, decision trees and random forests.
* <code>&nbsp;&nbsp;1185</code> ![](https://img.shields.io/github/last-commit/AtheMathmo/rusty-machine) [rusty-machine](https://github.com/AtheMathmo/rusty-machine) - a pure-rust machine learning library.
* <code>&nbsp;&nbsp;5475</code> ![](https://img.shields.io/github/last-commit/autumnai/leaf) [leaf](https://github.com/autumnai/leaf) - open source framework for machine intelligence, sharing concepts from TensorFlow and Caffe. Available under the MIT license. [**[Deprecated]**](https://medium.com/@mjhirn/tensorflow-wins-89b78b29aafb#.s0a3uy4cc)
* <code>&nbsp;&nbsp;&nbsp;307</code> ![](https://img.shields.io/github/last-commit/jackm321/RustNN) [RustNN](https://github.com/jackm321/RustNN) - RustNN is a feedforward neural network library. **[Deprecated]**
* <code>&nbsp;&nbsp;&nbsp;&nbsp;22</code> ![](https://img.shields.io/github/last-commit/avinashshenoy97/RusticSOM) [RusticSOM](https://github.com/avinashshenoy97/RusticSOM) - A Rust library for Self Organising Maps (SOM).
...
* <code>&nbsp;&nbsp;6464</code> ![](https://img.shields.io/github/last-commit/catboost/catboost) [CatBoost](https://github.com/catboost/catboost) - General purpose gradient boosting on decision trees library with categorical features support out of the box for R.
...
* <code>&nbsp;&nbsp;3618</code> ![](https://img.shields.io/github/last-commit/johnmyleswhite/ML_for_Hackers) [Machine Learning For Hackers](https://github.com/johnmyleswhite/ML_for_Hackers)
...
* <code>&nbsp;&nbsp;&nbsp;223</code> ![](https://img.shields.io/github/last-commit/ecpolley/SuperLearner) [SuperLearner](https://github.com/ecpolley/SuperLearner) - Multi-algorithm ensemble learning packages.
...
* <code>&nbsp;&nbsp;&nbsp;530</code> ![](https://img.shields.io/github/last-commit/tqchen/xgboost) [XGBoost.R](https://github.com/tqchen/xgboost/tree/master/R-package) - R binding for eXtreme Gradient Boosting (Tree) Library.
...
* <code>&nbsp;19941</code> ![](https://img.shields.io/github/last-commit/apache/incubator-mxnet) [MXNet](https://github.com/apache/incubator-mxnet) - Lightweight, Portable, Flexible Distributed/Mobile Deep Learning with Dynamic, Mutation-aware Dataflow Dep Scheduler; for Python, R, Julia, Go, Javascript and more.
* <code>&nbsp;&nbsp;&nbsp;359</code> ![](https://img.shields.io/github/last-commit/Azure/Azure-TDSP-Utilities) [TDSP-Utilities](https://github.com/Azure/Azure-TDSP-Utilities) - Two data science utilities in R from Microsoft: 1) Interactive Data Exploration, Analysis, and Reporting (IDEAR) ; 2) Automated Modeling and Reporting (AMR).
...
* <code>&nbsp;&nbsp;&nbsp;120</code> ![](https://img.shields.io/github/last-commit/sassoftware/enlighten-apply) [ML_Tables](https://github.com/sassoftware/enlighten-apply/tree/master/ML_tables) - Concise cheat sheets containing machine learning best practices.
* <code>&nbsp;&nbsp;&nbsp;120</code> ![](https://img.shields.io/github/last-commit/sassoftware/enlighten-apply) [enlighten-apply](https://github.com/sassoftware/enlighten-apply) - Example code and materials that illustrate applications of SAS machine learning techniques.
* <code>&nbsp;&nbsp;&nbsp;&nbsp;57</code> ![](https://img.shields.io/github/last-commit/sassoftware/enlighten-integration) [enlighten-integration](https://github.com/sassoftware/enlighten-integration) - Example code and materials that illustrate techniques for integrating SAS with other analytics technologies in Java, PMML, Python and R.
* <code>&nbsp;&nbsp;&nbsp;&nbsp;20</code> ![](https://img.shields.io/github/last-commit/sassoftware/enlighten-deep) [enlighten-deep](https://github.com/sassoftware/enlighten-deep) - Example code and materials that illustrate using neural networks with several hidden layers in SAS.
* <code>&nbsp;&nbsp;&nbsp;&nbsp;55</code> ![](https://img.shields.io/github/last-commit/sassoftware/dm-flow) [dm-flow](https://github.com/sassoftware/dm-flow) - Library of SAS Enterprise Miner process flow diagrams to help you learn by example about specific data mining topics.
...
* <code>&nbsp;&nbsp;3327</code> ![](https://img.shields.io/github/last-commit/scalanlp/breeze) [Breeze](https://github.com/scalanlp/breeze) - Breeze is a numerical processing library for Scala.
* <code>&nbsp;&nbsp;&nbsp;260</code> ![](https://img.shields.io/github/last-commit/scalanlp/chalk) [Chalk](https://github.com/scalanlp/chalk) - Chalk is a natural language processing library. **[Deprecated]**
* <code>&nbsp;&nbsp;&nbsp;556</code> ![](https://img.shields.io/github/last-commit/factorie/factorie) [FACTORIE](https://github.com/factorie/factorie) - FACTORIE is a toolkit for deployable probabilistic modeling, implemented as a software library in Scala. It provides its users with a succinct language for creating relational factor graphs, estimating parameters and performing inference.
* <code>&nbsp;&nbsp;&nbsp;&nbsp;52</code> ![](https://img.shields.io/github/last-commit/Workday/upshot-montague) [Montague](https://github.com/Workday/upshot-montague) - Montague is a semantic parsing library for Scala with an easy-to-use DSL.
* <code>&nbsp;&nbsp;2685</code> ![](https://img.shields.io/github/last-commit/JohnSnowLabs/spark-nlp) [Spark NLP](https://github.com/JohnSnowLabs/spark-nlp) - Natural language processing library built on top of Apache Spark ML to provide simple, performant, and accurate NLP annotations for machine learning pipelines, that scale easily in a distributed environment.

<a name="scala-data-analysis--data-visualization"></a>
#### Data Analysis / Data Visualization

* <code>&nbsp;&nbsp;&nbsp;&nbsp;37</code> ![](https://img.shields.io/github/last-commit/SciScala/NDScala) [NDScala](https://github.com/SciScala/NDScala) - N-dimensional arrays in Scala 3. Think NumPy ndarray, but with compile-time type-checking/inference over shapes, tensor/axis labels & numeric data types
* [MLlib in Apache Spark](https://spark.apache.org/docs/latest/mllib-guide.html) - Distributed machine learning library in Spark
* <code>&nbsp;&nbsp;&nbsp;317</code> ![](https://img.shields.io/github/last-commit/Hydrospheredata/mist) [Hydrosphere Mist](https://github.com/Hydrospheredata/mist) - a service for deployment Apache Spark MLLib machine learning models as realtime, batch or reactive web services.
* <code>&nbsp;&nbsp;3347</code> ![](https://img.shields.io/github/last-commit/twitter/scalding) [Scalding](https://github.com/twitter/scalding) - A Scala API for Cascading.
* <code>&nbsp;&nbsp;2120</code> ![](https://img.shields.io/github/last-commit/twitter/summingbird) [Summing Bird](https://github.com/twitter/summingbird) - Streaming MapReduce with Scalding and Storm.
* <code>&nbsp;&nbsp;2115</code> ![](https://img.shields.io/github/last-commit/twitter/algebird) [Algebird](https://github.com/twitter/algebird) - Abstract Algebra for Scala.
* <code>&nbsp;&nbsp;&nbsp;&nbsp;17</code> ![](https://img.shields.io/github/last-commit/xerial/xerial) [xerial](https://github.com/xerial/xerial) - Data management utilities for Scala. **[Deprecated]**
* <code>&nbsp;12511</code> ![](https://img.shields.io/github/last-commit/apache/predictionio) [PredictionIO](https://github.com/apache/predictionio) - PredictionIO, a machine learning server for software developers and data engineers.
* <code>&nbsp;&nbsp;&nbsp;266</code> ![](https://img.shields.io/github/last-commit/BIDData/BIDMat) [BIDMat](https://github.com/BIDData/BIDMat) - CPU and GPU-accelerated matrix library intended to support large-scale exploratory data analysis.
* [Flink](https://flink.apache.org/) - Open source platform for distributed stream and batch data processing.
...
* <code>&nbsp;&nbsp;3261</code> ![](https://img.shields.io/github/last-commit/Azure/mmlspark) [Microsoft ML for Apache Spark](https://github.com/Azure/mmlspark) -> A distributed machine learning framework Apache Spark
* <code>&nbsp;&nbsp;&nbsp;102</code> ![](https://img.shields.io/github/last-commit/EmergentOrder/onnx-scala) [ONNX-Scala](https://github.com/EmergentOrder/onnx-scala) - An ONNX (Open Neural Network eXchange) API and backend for typeful, functional deep learning in Scala (3).
...
* <code>&nbsp;&nbsp;&nbsp;358</code> ![](https://img.shields.io/github/last-commit/etsy/Conjecture) [Conjecture](https://github.com/etsy/Conjecture) - Scalable Machine Learning in Scalding.
* <code>&nbsp;&nbsp;&nbsp;395</code> ![](https://img.shields.io/github/last-commit/stripe/brushfire) [brushfire](https://github.com/stripe/brushfire) - Distributed decision tree ensemble learning in Scala.
* <code>&nbsp;&nbsp;&nbsp;110</code> ![](https://img.shields.io/github/last-commit/tresata/ganitha) [ganitha](https://github.com/tresata/ganitha) - Scalding powered machine learning. **[Deprecated]**
* <code>&nbsp;&nbsp;&nbsp;924</code> ![](https://img.shields.io/github/last-commit/bigdatagenomics/adam) [adam](https://github.com/bigdatagenomics/adam) - A genomics processing engine and specialized file format built using Apache Avro, Apache Spark and Parquet. Apache 2 licensed.
* <code>&nbsp;&nbsp;&nbsp;104</code> ![](https://img.shields.io/github/last-commit/bioscala/bioscala) [bioscala](https://github.com/bioscala/bioscala) - Bioinformatics for the Scala programming language
* <code>&nbsp;&nbsp;&nbsp;911</code> ![](https://img.shields.io/github/last-commit/BIDData/BIDMach) [BIDMach](https://github.com/BIDData/BIDMach) - CPU and GPU-accelerated Machine Learning Library.
* <code>&nbsp;&nbsp;&nbsp;737</code> ![](https://img.shields.io/github/last-commit/p2t2/figaro) [Figaro](https://github.com/p2t2/figaro) - a Scala library for constructing probabilistic models.
* <code>&nbsp;&nbsp;&nbsp;923</code> ![](https://img.shields.io/github/last-commit/h2oai/sparkling-water) [H2O Sparkling Water](https://github.com/h2oai/sparkling-water) - H2O and Spark interoperability.
* [FlinkML in Apache Flink](https://ci.apache.org/projects/flink/flink-docs-master/dev/libs/ml/index.html) - Distributed machine learning library in Flink.
* <code>&nbsp;&nbsp;&nbsp;199</code> ![](https://img.shields.io/github/last-commit/transcendent-ai-labs/DynaML) [DynaML](https://github.com/transcendent-ai-labs/DynaML) - Scala Library/REPL for Machine Learning Research.
* <code>&nbsp;&nbsp;&nbsp;&nbsp;64</code> ![](https://img.shields.io/github/last-commit/CogComp/saul) [Saul](https://github.com/CogComp/saul) - Flexible Declarative Learning-Based Programming.
* <code>&nbsp;&nbsp;&nbsp;&nbsp;38</code> ![](https://img.shields.io/github/last-commit/valdanylchuk/swiftlearner) [SwiftLearner](https://github.com/valdanylchuk/swiftlearner/) - Simply written algorithms to help study ML or write your own implementations.
* [Smile](https://haifengl.github.io/) - Statistical Machine Intelligence and Learning Engine.
* <code>&nbsp;&nbsp;&nbsp;141</code> ![](https://img.shields.io/github/last-commit/picnicml/doddle-model) [doddle-model](https://github.com/picnicml/doddle-model) - An in-memory machine learning library built on top of Breeze. It provides immutable objects and exposes its functionality through a scikit-learn-like API.
* <code>&nbsp;&nbsp;&nbsp;892</code> ![](https://img.shields.io/github/last-commit/eaplatanios/tensorflow_scala) [TensorFlow Scala](https://github.com/eaplatanios/tensorflow_scala) -   Strongly-typed Scala API for TensorFlow.
...
* <code>&nbsp;&nbsp;&nbsp;550</code> ![](https://img.shields.io/github/last-commit/cloudkj/layer) [layer](https://github.com/cloudkj/layer) - Neural network inference from the command line, implemented in [CHICKEN Scheme](https://www.call-cc.org/).
...
* <code>&nbsp;&nbsp;1736</code> ![](https://img.shields.io/github/last-commit/xmartlabs/Bender) [Bender](https://github.com/xmartlabs/Bender) - Fast Neural Networks framework built on top of Metal. Supports TensorFlow models.
* <code>&nbsp;&nbsp;5857</code> ![](https://img.shields.io/github/last-commit/Swift-AI/Swift-AI) [Swift AI](https://github.com/Swift-AI/Swift-AI) - Highly optimized artificial intelligence and machine learning library written in Swift.
* <code>&nbsp;&nbsp;6053</code> ![](https://img.shields.io/github/last-commit/tensorflow/swift) [Swift for Tensorflow](https://github.com/tensorflow/swift) - a next-generation platform for machine learning, incorporating the latest research across machine learning, compilers, differentiable programming, systems design, and beyond.
* <code>&nbsp;&nbsp;&nbsp;379</code> ![](https://img.shields.io/github/last-commit/alejandro-isaza/BrainCore) [BrainCore](https://github.com/alejandro-isaza/BrainCore) - The iOS and OS X neural network framework.
* <code>&nbsp;&nbsp;&nbsp;585</code> ![](https://img.shields.io/github/last-commit/stsievert/swix) [swix](https://github.com/stsievert/swix) - A bare bones library that includes a general matrix language and wraps some OpenCV for iOS development. **[Deprecated]**
* <code>&nbsp;&nbsp;&nbsp;769</code> ![](https://img.shields.io/github/last-commit/KevinCoble/AIToolbox) [AIToolbox](https://github.com/KevinCoble/AIToolbox) - A toolbox framework of AI modules written in Swift: Graphs/Trees, Linear Regression, Support Vector Machines, Neural Networks, PCA, KMeans, Genetic Algorithms, MDP, Mixture of Gaussians.
* <code>&nbsp;&nbsp;&nbsp;151</code> ![](https://img.shields.io/github/last-commit/Somnibyte/MLKit) [MLKit](https://github.com/Somnibyte/MLKit) - A simple Machine Learning Framework written in Swift. Currently features Simple Linear Regression, Polynomial Regression, and Ridge Regression.
* <code>&nbsp;&nbsp;&nbsp;327</code> ![](https://img.shields.io/github/last-commit/vlall/Swift-Brain) [Swift Brain](https://github.com/vlall/Swift-Brain) - The first neural network / machine learning library written in Swift. This is a project for AI algorithms in Swift for iOS and OS X development. This project includes algorithms focused on Bayes theorem, neural networks, SVMs, Matrices, etc...
* <code>&nbsp;&nbsp;&nbsp;167</code> ![](https://img.shields.io/github/last-commit/PerfectlySoft/Perfect-TensorFlow) [Perfect TensorFlow](https://github.com/PerfectlySoft/Perfect-TensorFlow) - Swift Language Bindings of TensorFlow. Using native TensorFlow models on both macOS / Linux.
* <code>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;8</code> ![](https://img.shields.io/github/last-commit/denissimon/prediction-builder-swift) [PredictionBuilder](https://github.com/denissimon/prediction-builder-swift) - A library for machine learning that builds predictions using a linear regression.
* <code>&nbsp;&nbsp;&nbsp;519</code> ![](https://img.shields.io/github/last-commit/SwiftBrain/awesome-CoreML-models) [Awesome CoreML](https://github.com/SwiftBrain/awesome-CoreML-models) - A curated list of pretrained CoreML models.
* <code>&nbsp;&nbsp;5310</code> ![](https://img.shields.io/github/last-commit/likedan/Awesome-CoreML-Models) [Awesome Core ML Models](https://github.com/likedan/Awesome-CoreML-Models) - A curated list of machine learning models in CoreML format.
...
#### General-Purpose Machine Learning
* <code>&nbsp;16611</code> ![](https://img.shields.io/github/last-commit/jtoy/awesome-tensorflow) [Awesome TensorFlow](https://github.com/jtoy/awesome-tensorflow) - A list of all things related to TensorFlow.
...
#### Neural Networks
* <code>&nbsp;&nbsp;&nbsp;550</code> ![](https://img.shields.io/github/last-commit/cloudkj/layer) [layer](https://github.com/cloudkj/layer) - Neural network inference from the command line

<a name="tools-misc"></a>
#### Misc

* [milvus](https://milvus.io) – Milvus is <code>&nbsp;10089</code> ![](https://img.shields.io/github/last-commit/milvus-io/milvus) [open source](https://github.com/milvus-io/milvus) vector database for production AI, written in Go and C++, scalable and blazing fast for billions of embedding vectors. 
* [Weaviate](https://www.semi.technology/developers/weaviate/current/) – Weaviate is an <code>&nbsp;&nbsp;2382</code> ![](https://img.shields.io/github/last-commit/semi-technologies/weaviate) [open source](https://github.com/semi-technologies/weaviate) vector search engine and vector database. Weaviate uses machine learning to vectorize and store data, and to find answers to natural language queries. With Weaviate you can also bring your custom ML models to production scale.
...
* <code>&nbsp;&nbsp;2499</code> ![](https://img.shields.io/github/last-commit/ml-tooling/ml-workspace) [ML Workspace](https://github.com/ml-tooling/ml-workspace) - All-in-one web-based IDE for machine learning and data science. The workspace is deployed as a docker container and is preloaded with a variety of popular data science libraries (e.g., Tensorflow, PyTorch) and dev tools (e.g., Jupyter, VS Code).
* <code>&nbsp;&nbsp;&nbsp;&nbsp;24</code> ![](https://img.shields.io/github/last-commit/rlan/notebooks) [Notebooks](https://github.com/rlan/notebooks) - A starter kit for Jupyter notebooks and machine learning. Companion docker images consist of all combinations of python versions, machine learning frameworks (Keras, PyTorch and Tensorflow) and CPU/CUDA versions.
* <code>&nbsp;&nbsp;9576</code> ![](https://img.shields.io/github/last-commit/iterative/dvc) [DVC](https://github.com/iterative/dvc) - Data Science Version Control is an open-source version control system for machine learning projects with pipelines support. It makes ML projects reproducible and shareable.
* <code>&nbsp;&nbsp;&nbsp;&nbsp;52</code> ![](https://img.shields.io/github/last-commit/iterative/dvclive) [DVClive](https://github.com/iterative/dvclive) - Python library for experiment metrics logging into simply formatted local files.
* <code>&nbsp;&nbsp;6818</code> ![](https://img.shields.io/github/last-commit/quantumblacklabs/kedro) [Kedro](https://github.com/quantumblacklabs/kedro/) - Kedro is a data and development workflow framework that implements best practices for data pipelines with an eye towards productionizing machine learning models.
...
* <code>&nbsp;&nbsp;3782</code> ![](https://img.shields.io/github/last-commit/IDSIA/sacred) [Sacred](https://github.com/IDSIA/sacred) - Python tool to help  you configure, organize, log and reproduce experiments. Like a notebook lab in the context of Chemistry/Biology. The community has built multiple add-ons leveraging the proposed standard.
...
* More tools to improve the ML lifecycle: <code>&nbsp;&nbsp;2900</code> ![](https://img.shields.io/github/last-commit/catalyst-team/catalyst) [Catalyst](https://github.com/catalyst-team/catalyst), [PachydermIO](https://www.pachyderm.io/). The following are Github-alike and targeting teams [Weights & Biases](https://www.wandb.com/), [Neptune.ai](https://neptune.ai/), [Comet.ml](https://www.comet.ml/), [Valohai.ai](https://valohai.com/), [DAGsHub](https://DAGsHub.com/).
...
* <code>&nbsp;&nbsp;2077</code> ![](https://img.shields.io/github/last-commit/BayesWitnesses/m2cgen) [m2cgen](https://github.com/BayesWitnesses/m2cgen) - A tool that allows the conversion of ML models into native code (Java, C, Python, Go, JavaScript, Visual Basic, C#, R, PowerShell, PHP, Dart) with zero dependencies.
* <code>&nbsp;&nbsp;3093</code> ![](https://img.shields.io/github/last-commit/iterative/cml) [CML](https://github.com/iterative/cml) - A library for doing continuous integration with ML projects. Use GitHub Actions & GitLab CI to train and evaluate models in production like environments and automatically generate visual reports with metrics and graphs in pull/merge requests. Framework & language agnostic.
...
* <code>&nbsp;&nbsp;&nbsp;329</code> ![](https://img.shields.io/github/last-commit/chaos-genius/chaos_genius) [Chaos Genius](https://github.com/chaos-genius/chaos_genius/) - ML powered analytics engine for outlier/anomaly detection and root cause analysis.

<a name="books"></a>
## Books

* <code>&nbsp;&nbsp;&nbsp;119</code> ![](https://img.shields.io/github/last-commit/terrytangyuan/distributed-ml-patterns) [Distributed Machine Learning Patterns](https://github.com/terrytangyuan/distributed-ml-patterns)  - This book teaches you how to take machine learning models from your personal laptop to large distributed clusters. You’ll explore key concepts and patterns behind successful distributed machine learning systems, and learn technologies like TensorFlow, Kubernetes, Kubeflow, and Argo Workflows directly from a key maintainer and contributor, with real-world scenarios and hands-on projects.
...
* Some of the python libraries were cut-and-pasted from <code>124039</code> ![](https://img.shields.io/github/last-commit/vinta/awesome-python) [vinta](https://github.com/vinta/awesome-python)
* References for Go were mostly cut-and-pasted from <code>&nbsp;&nbsp;&nbsp;777</code> ![](https://img.shields.io/github/last-commit/gopherdata/resources) [gopherdata](https://github.com/gopherdata/resources/tree/master/tooling)
